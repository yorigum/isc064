...
<%@ Page language="c#" Inherits="ISC064.FINANCEAR.KasKeluarEdit" CodeFile="KasKeluarEdit.aspx.cs" %>
<!DOCTYPE html>
<html>
	<head>
		...
		<meta name="sec" content="Tanda Terima Sementara - Edit Kas Keluar">
			...
			<div class="pad">
				<table cellspacing="5">
					<tr valign="top">
						...
						<td>Print :</td>
						<td class="printhref">
							<p><a id="printKK" runat="server"><b>Voucher Kas Keluar</b></a></p>
						</td>
						<td width="100%"></td>
						<td>

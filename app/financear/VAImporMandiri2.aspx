<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VAImporMandiri2.aspx.cs" Inherits="ISC064.FINANCEAR.VAImporMandiri2" %>

<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html>
<head>
    <title>Impor Data Transaksi Virtual Account Mandiri (hal 2)</title>
    ...
    <meta name="sec" content="Virtual Account - Impor Data Transaksi Mandiri (Hal. 2)">
</head>
<body>
    <form class="cnt" id="Form1" method="post" runat="server">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <h1>Import Data Transaksi Virtual Account BRI</h1>
        <br />
        <p class="feed">
        ...
        <div id="div1" runat="server">
            ...
            <table style="height: 50">
                <tr>
                    ...
                    <td>
                        <input class="btn btn-red" id="cancel" style="width: 75px" onclick="location.href = 'VAImporBRI.aspx'"

<%@ Page Language="c#" Inherits="ISC064.FINANCEAR.ReminderUnallocated" CodeFile="ReminderUnallocated.aspx.cs" %>

<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html>
<head>
    <title>Reminder Pelunasan Unallocated</title>
    ...
    <meta name="sec" content="Reminder - Pelunasan Allocated">
</head>
<body class="body-padding" onkeyup="if(event.keyCode==27)document.getElementById('cancel').click()">
    <form id="Form1" method="post" runat="server" class="cnt">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <h1 class="title title-line">Reminder Pelunasan Unallocated</h1>
        <p class="feed">
        ...
        <asp:GridView ID="tb" runat="server" SkinID="pager" OnPageIndexChanging="tb_PageIndexChanging">
            <Columns>
                <asp:BoundField HeaderText="Tipe" DataField="Tipe" ItemStyle-VerticalAlign="Top"/>

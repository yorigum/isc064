...
namespace ISC064.FINANCEAR
{
	public partial class LogDetil : System.Web.UI.Page
	{
		...
		{
			FillAkt(akt1 , "MS_TTS_LOG");
			FillAkt(akt2 , "MS_ANONIM_LOG");
			FillAkt(akt3 , "REF_ACC_LOG");
			FillAkt(akt4 , "MS_KASMASUK_LOG");
			FillAkt(akt5 , "MS_KASKELUAR_LOG");
            FillAkt(akt6, "MS_MEMO_LOG");

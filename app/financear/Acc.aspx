<%@ Page Language="c#" Inherits="ISC064.FINANCEAR.Acc" CodeFile="Acc.aspx.cs" %>
                ...
                <td>
                    ...
                    <table cellspacing="5">
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <asp:DropDownList ID="project" runat="server" OnSelectedIndexChanged="project_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td>Rekening</td>

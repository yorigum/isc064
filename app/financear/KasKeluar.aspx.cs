...
{
	public partial class KasKeluar : System.Web.UI.Page
	{
			...
			if(!Page.IsPostBack)
			{
				if(Request.QueryString["done"]!=null)
					feed.Text = "<img src='/Media/db.gif' align=absmiddle> "
						+ "<a href=\"javascript:popEditKasKeluar('"+Request.QueryString["done"]+"')\">"
		...
		protected void ok_Click(object sender, System.EventArgs e)
		{
			if(valid())
			{
				...
				int NoVoucher = Db.SingleInteger(
					"SELECT TOP 1 NoVoucher FROM MS_KASKELUAR ORDER BY NoVoucher DESC");
				...
				Response.Redirect("KasKeluar.aspx?done=" + NoVoucher);
			}
		}

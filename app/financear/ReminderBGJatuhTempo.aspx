<%@ Page Language="c#" Inherits="ISC064.FINANCEAR.ReminderBGJatuhTempo" CodeFile="ReminderBGJatuhTempo.aspx.cs" %>

<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html>
<head>
    <title>Reminder Cek Giro Jatuh Tempo</title>
    ...
    <meta name="sec" content="Reminder - Cek Giro Jatuh Tempo">
</head>
<body class="body-padding" onkeyup="if(event.keyCode==27)document.getElementById('cancel').click()">
    <form id="Form1" method="post" runat="server" class="cnt">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <h1 class="title title-line">Reminder Cek Giro Jatuh Tempo</h1>
        <br />
        <p class="feed">

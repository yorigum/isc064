...
<%@ Page Language="c#" Inherits="ISC064.FINANCEAR.MemoRegistrasi" CodeFile="MemoRegistrasi.aspx.cs" %>
...
<head>
    ...
    <meta name="sec" content="Memo Pelunasan - Registrasi Memo">
</head>
        ...
        <script type="text/javascript">
            function call(ref, tipe) {
                if (tipe == "TENANT")
                    ...
                    location.href = 'MemoRegistrasiMarketing.aspx?Ref=' + ref + '&Tipe=' + tipe;
            }
        </script>
    </form>
</body>

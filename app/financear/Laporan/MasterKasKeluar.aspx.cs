...
{
	public partial class MasterKasKeluar : System.Web.UI.Page
	{
		...
		private void Fill()
		{
			...
			for(int i=0;i<rs.Rows.Count;i++)
			{
				...
				r.Attributes["ondblclick"] = "popEditKasKeluar('"+rs.Rows[i]["NoVoucher"]+"')";
				...
				c = new TableCell();
				c.Text = rs.Rows[i]["DibayarKepada"].ToString();
				c.HorizontalAlign = HorizontalAlign.Left;
				r.Cells.Add(c);

...
namespace ISC064.FINANCEAR
{
    public partial class Acc : System.Web.UI.Page
    {
        ...
        private void FillTable()
        {
            ...
            DataTable rs = Db.Rs("SELECT * FROM " + Mi.DbPrefix + "FINANCEAR..REF_ACC WHERE Project = '" + project.SelectedValue + "'");
        ...
        private bool unik()
        {
            ...
            int c = Db.SingleInteger("SELECT COUNT(*) FROM " + Mi.DbPrefix + "FINANCEAR..REF_ACC WHERE"
                + " Acc = '" + Acc + "' AND Project = '" + project.SelectedValue + "'"
                );
        ...
        private bool valid()
        {
            ...
            decimal jum = Db.SingleDecimal("SELECT COUNT(*) FROM " + Mi.DbPrefix + "FINANCEAR..REF_ACC WHERE ACC='" + acc.Text + "' AND Project = '" + project.SelectedValue + "'");

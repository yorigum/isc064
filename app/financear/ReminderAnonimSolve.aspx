<%@ Page Language="c#" Inherits="ISC064.FINANCEAR.ReminderAnonimSolve" CodeFile="ReminderAnonimSolve.aspx.cs" %>

<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html>
<head>
    <title>Reminder Transfer Anonim Belum Solve</title>
    ...
    <meta name="sec" content="Reminder - Transfer Anonim Belum Solve">
</head>
<body class="body-padding" onkeyup="if(event.keyCode==27)document.getElementById('cancel').click()">
    <form id="Form1" method="post" runat="server" class="cnt">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <h1 class="title title-line">Reminder Transfer Anonim Belum Solve</h1>
        <p class="feed">

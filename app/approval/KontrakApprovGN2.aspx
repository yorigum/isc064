<%@ Page Language="c#" Inherits="ISC064.APPROVAL.KontrakApprovGN2" CodeFile="KontrakApprovGN2.aspx.cs" %>
        ...
        <div>
            ...
            <table cellspacing="5">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Label ID="custlama" runat="server" Font-Bold="True"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>Customer Baru
                    ...
                    <td>
                        <asp:Label ID="custbaru" runat="server" Font-Bold="True"></asp:Label>
                    </td>
                </tr>
                <tr>

<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KontrakApprovADJ.aspx.cs" Inherits="KontrakApprovADJ" %>--%>

<%@ Page Language="c#" Inherits="ISC064.APPROVAL.KontrakApprovADJ" CodeFile="KontrakApprovADJ.aspx.cs" %>
...
<head>
    ...
    <meta name="sec" content="Kontrak Approval Adjustsment">
</head>
<body class="body-padding">
    <form id="Form1" method="post" runat="server" class="cnt">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <h1 class="title title-line">Approval Adjustment Kontrak</h1>
        <br>

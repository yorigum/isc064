<%@ Page Language="c#" Inherits="ISC064.SETTINGS.LogPk" CodeFile="LogPk.aspx.cs" %>
...
<body class="body-padding" onkeyup="if(event.keyCode==27)history.back(-1)">
    <form id="Form1" method="post" runat="server" class="cnt">
        ...
        <asp:RadioButtonList ID="tb" runat="server" Visible="False">
            <asp:ListItem Value="HTMLEDITOR_LOG">HTMLEDITOR</asp:ListItem>
            <asp:ListItem Value="ISC064_MARKETINGJUAL..REF_LOKASI_LOG">LOKASI</asp:ListItem>
            <asp:ListItem Value="ISC064_MARKETINGJUAL..REF_JENIS_LOG">JENIS</asp:ListItem>
            <asp:ListItem Value="ISC064_MARKETINGJUAL..REF_JENISPROPERTI_LOG">JENIS PROPERTI</asp:ListItem>
            <asp:ListItem Value="ISC064_MARKETINGJUAL..REF_BERKAS_PPJB_LOG">BERKAS PPJB</asp:ListItem>
        </asp:RadioButtonList>
        <br>

...
{
    public partial class JenisPropertiDaftar : System.Web.UI.Page
    {
        ...
        private void FeedBack()
        {
            ...
            if (!Page.IsPostBack)
            {
                if (Request.QueryString["done"] != null)
                {
                    ...
                    {
                        feed.Text = "<img src='/Media/db.gif' align=absmiddle> "
                            + "<a href=\"javascript:popEditJenisProperti('" + Request.QueryString["done"] + "')\">"
        ...
        private void AutoID()
        {
            int c = Db.SingleInteger("SELECT COUNT(SN) FROM " + Mi.DbPrefix + "MARKETINGJUAL..REF_JENISPROPERTI");
        ...
        private bool isUnique()
        {
            ...
            int c = Db.SingleInteger(
                "SELECT COUNT(*) FROM " + Mi.DbPrefix + "MARKETINGJUAL..REF_JENISPROPERTI WHERE SN = '" + NoJenis + "'");
        ...
        private void Fill()
        {
            string strSql = "SELECT TOP 25 JenisProperti,SN, Nama "
                + " FROM " + Mi.DbPrefix + "MARKETINGJUAL..REF_JENISPROPERTI "
            ...
            for (int i = 0; i < rs.Rows.Count; i++)
            {
                ...
                string x = rs.Rows[i]["JenisProperti"].ToString();
            ...
            if (rs.Rows.Count != 0)
            {
                ...
                baru.Attributes["ondblclick"] = "popEditJenisProperti("

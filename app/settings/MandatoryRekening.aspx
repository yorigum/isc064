<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MandatoryRekening.aspx.cs" Inherits="ISC064.SETTINGS.MandatoryRekening" %>
...
<body class="body-padding">
    <form id="Form1" method="post" runat="server" class="cnt">
        <h1 class="title title-line">Setup Mandatory Rekening</h1>

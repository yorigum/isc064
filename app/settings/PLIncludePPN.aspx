<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PLIncludePPN.aspx.cs" Inherits="ISC064.SETTINGS.PLIncludePPN" %>
...
<head>
    ...
    <meta name="sec" content="Mandatori Pendaftaran Rekening">
</head>
<body class="body-padding">
    <form id="Form1" method="post" runat="server" class="cnt">
        <h1 class="title title-line">Setup Price List Include</h1>

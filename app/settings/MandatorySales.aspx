<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MandatorySales.aspx.cs" Inherits="ISC064.SETTINGS.MandatorySales" %>
...
<head>
    ...
    <meta name="sec" content="Mandatori Pendaftaran Sales">
</head>
<body class="body-padding">
    <form id="Form1" method="post" runat="server" class="cnt">
        <h1 class="title title-line">Setup Mandatory Sales</h1>

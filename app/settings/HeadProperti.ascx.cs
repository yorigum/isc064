namespace ISC064.SETTINGS
{
	...
	public partial class HeadProperti : System.Web.UI.UserControl
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			if(!Page.IsPostBack)
			{
				...
				int p = Db.SingleInteger("SELECT ISNULL((SELECT TOP 1 SN FROM " + Mi.DbPrefix + "MARKETINGJUAL..REF_JENISPROPERTI WHERE SN < '" + NoJenis + "' ORDER BY SN DESC),'')");
				int n = Db.SingleInteger("SELECT ISNULL((SELECT TOP 1 SN FROM " + Mi.DbPrefix + "MARKETINGJUAL..REF_JENISPROPERTI WHERE SN > '" + NoJenis + "' ORDER BY SN ASC),'')");
                ...
                string strSql = "SELECT * FROM ISC064_MARKETINGJUAL..REF_JENISPROPERTI WHERE SN = '" + NoJenis + "'";

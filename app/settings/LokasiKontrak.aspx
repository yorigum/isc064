...
<%@ Page Language="C#" Inherits="ISC064.ADMINJUAL.LokasiKontrak" CodeFile="LokasiKontrak.aspx.cs" %>

<!DOCTYPE html>

<html lang="en">
<head runat="server">
    <title>Pendaftaran Lokasi Penjualan Baru</title>
    ...
    <meta name="sec" content="Lokasi Kontrak - Pendaftaran Lokasi Kontrak Baru">
</head>
<body class="body-padding">
    <form class="cnt" id="Form1" method="post" runat="server">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <h1 class="title title-line">Pendaftaran Lokasi Penjualan Baru</h1>
        <br />
        <table cellspacing="0">
            <tr valign="top">
                <td style="padding-right: 10px">
                    ...
                    <asp:ListBox ID="baru" Rows="25" runat="server" Width="300px" CssClass="ddl"></asp:ListBox>
                    <p class="feed">
                ...
                <td>
                    ...
                    <table cellspacing="5">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="nolokasi" runat="server" CssClass="txt" Width="65" Font-Bold="True"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="lokasi" runat="server" CssClass="txt" Width="75" MaxLength="20"></asp:TextBox>
                                <asp:Label ID="lokasic" runat="server" CssClass="err"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>Nama Lokasi Kontrak
                            </td>
                            <td>:
                            </td>
                            <td>
                                <asp:TextBox ID="namalokasi" runat="server" CssClass="txt" Width="200" MaxLength="100"></asp:TextBox>

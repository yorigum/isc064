...
<%@ Page Language="c#" Inherits="ISC064.ADMINJUAL.JenisPropertiDaftar" CodeFile="JenisPropertiDaftar.aspx.cs" %>

<!DOCTYPE html>
<html lang="en">
<head>
    <title>Pendaftaran Jenis Properti Unit Baru</title>
    ...
    <meta name="sec" content="Jenis Properti Unit - Pendaftaran Jenis Properti Unit Baru">
</head>
<body class="body-padding">
    <form class="cnt" id="Form1" method="post" runat="server">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <h1 class="title title-line">Pendaftaran Tipe Properti Baru</h1>
        <br />
        <table cellspacing="0">
            <tr valign="top">

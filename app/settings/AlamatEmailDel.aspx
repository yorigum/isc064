...
<%@ Page language="c#" Inherits="ISC064.SETTINGS.AlamatEmailDel" CodeFile="AlamatEmailDel.aspx.cs" %>
<!DOCTYPE html>
<html>
	<head>
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:label id="nodel" runat="server" visible="false">
				...
				<div class="plike">
					...
					<ul>
						<li>
							Email tersebut sudah pernah dipakai dalam transaksi kas bank.
						</li>
					</ul>
				</div>
			</asp:label>

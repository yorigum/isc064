...
<%@ Page Language="c#" Inherits="ISC064.SETTINGS.JenisPropertiDel" CodeFile="JenisPropertiDel.aspx.cs" %>
...
<head>
    ...
    <meta name="sec" content="Jenis Properti Unit - Delete Jenis Properti Unit">
</head>
<body class="body-padding" onkeyup="if(event.keyCode==27) history.back(-1)">
    <form id="Form1" method="post" runat="server">
        <div id="frm" runat="server">
            <input type="text" style="display: none">
            <h1 class="title title-line">Delete Jenis Properti Unit</h1>
            <br>
            Keterangan :
        ...
        <asp:Label ID="nodel" runat="server" Visible="false">
				<h1>
					Jenis Properti Unit Tidak Dapat Dihapus
				</h1>
				<br>
				<div class="plike">
					...
					<ul>
						...
						<li>
							Jenis Properti Unit tersebut sudah memiliki unit dan kontrak
						</li>
					</ul>
				</div>
        </asp:Label>

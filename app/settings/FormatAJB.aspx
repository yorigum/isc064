<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormatAJB.aspx.cs" Inherits="ISC064.SETTINGS.FormatAJB" %>
...
<html>
<head>
    <title>Minimum Pelunasan AJB</title>
...
<body class="body-padding">
    <form id="Form1" method="post" runat="server" class="cnt">
        ...
        <div>
            <h1 class="title title-line">Minimum Pelunasan AJB</h1>
            <br>
            <table>
                <tr>
                    <td>

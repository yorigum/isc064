...
namespace ISC064.SETTINGS
{
    public partial class Log : System.Web.UI.Page
    {
        ...
        private void Fill2()
        {
            ...
            string popup = "";
            if (href.SelectedItem.Value == "HTMLEDITOR_LOG")
            {
                popup = ",'<a href=\"javascript:PopHtmlEditor('''+Pk+''')\">' + Pk +  '</a>'";
            }
            else if (href.SelectedItem.Value == "ISC064_MARKETINGJUAL..REF_LOKASI_LOG")
            {
                popup = ",'<a href=\"javascript:popEditLokasi('''+Pk+''')\">' + Pk +  '</a>'";
            }
            else if (href.SelectedItem.Value == "ISC064_MARKETINGJUAL..REF_JENIS_LOG")
            {
                popup = ",'<a href=\"javascript:popEditJenis('''+Pk+''')\">' + Pk +  '</a>'";
            }
            else if (href.SelectedItem.Value == "ISC064_MARKETINGJUAL..REF_JENISPROPERTI_LOG")
            {
                popup = ",'<a href=\"javascript:popEditJenisProperti('''+Pk+''')\">' + Pk +  '</a>'";
            }
            else if (href.SelectedItem.Value == "ISC064_MARKETINGJUAL..REF_BERKAS_PPJB_LOG")
            {
                popup = ",'<a href=\"javascript:popEditBerkasPPJB('''+Pk+''')\">' + Pk +  '</a>'";
            }
            else
                popup = ",'+Pk+'";

<%@ Page Language="c#" Inherits="ISC064.SETTINGS.ApprovalDetailEdit" CodeFile="ApprovalDetailEdit.aspx.cs" %>
...
<head>
    ...
    <meta name="sec" content="Approval - Detail Edit">
    <style type="text/css">
        .list td {
            width: 220px;
            padding-left: 50px;
...
<body class="body-padding">
    <form id="Form1" method="post" runat="server" class="cnt">
        ...
        <script type="text/javascript">
            ...
            function hapusbaris(row, tipe, lvl, project) {
                userid = $('#userid_' + row).val();

                if (confirm('Hapus satu baris detail ini dari approval?\nPerhatian bahwa data akan dihapus secara PERMANEN.')) {                    
                    location.href = 'ApprovalDetailDel.aspx?userid=' + userid + '&tipe=' + tipe + '&lvl=' + lvl+'&project='+project;
                }
            }
        </script>
    </form>

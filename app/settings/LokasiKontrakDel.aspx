...
<%@ Page Language="C#" CodeFile="LokasiKontrakDel.aspx.cs" Inherits="ISC064.ADMINJUAL.LokasiKontrakDel" %>

<!DOCTYPE html>

<html lang="en">
<head runat="server">
    <title>Delete Lokasi Penjualan</title>
    ...
    <meta name="sec" content="Lokasi Kontrak - Delete Lokasi Kontrak">
</head>
<body class="body-padding" onkeyup="if(event.keyCode==27) history.back(-1)">
    <form id="Form1" method="post" runat="server">
        <div id="frm" runat="server">
            <input type="text" style="display: none">
            <h1 class="title title-line">Delete Lokasi Penjualan</h1>
            <br>
            Keterangan :

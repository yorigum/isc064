<%@ Page Language="c#" Inherits="ISC064.SETTINGS.JenisPropertiEdit" CodeFile="JenisPropertiEdit.aspx.cs" %>

<%@ Register TagPrefix="uc1" TagName="HeadProperti" Src="HeadProperti.ascx" %>
<%@ Register TagPrefix="uc1" TagName="NavProperti" Src="NavProperti.ascx" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>Edit Jenis Properti Unit</title>
    ...
    <meta name="sec" content="Jenis Properti Unit - Edit Properti Jenis Unit">
</head>
<body onkeyup="if(event.keyCode==27) window.close()">
    <form id="Form1" method="post" runat="server">
        <div class="content-header">
            <uc1:NavProperti id="NavUnit1" runat="server" aktif="1"></uc1:NavProperti>
        </div>
        <div class="tabdata">
            <div class="pad">
                <uc1:HeadProperti id="HeadUnit1" runat="server"></uc1:HeadProperti>
                <table cellspacing="5">
                    <tr>
                        <td width="100%"></td>
                        <td>

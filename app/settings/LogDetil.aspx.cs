...
namespace ISC064.SETTINGS
{
	public partial class LogDetil : System.Web.UI.Page
	{
		...
		{
			FillAkt(akt1 , "HTMLEDITOR_LOG");
            FillAkt(akt2, "ISC064_MARKETINGJUAL..REF_LOKASI_LOG");
            FillAkt(akt3, "ISC064_MARKETINGJUAL..REF_JENIS_LOG");
            FillAkt(akt4 , "ISC064_MARKETINGJUAL..REF_JENISPROPERTI_LOG");
            FillAkt(akt5, "ISC064_MARKETINGJUAL..REF_BERKAS_PPJB_LOG");

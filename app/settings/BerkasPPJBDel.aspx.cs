...
{
    public partial class BerkasPPJBDel : System.Web.UI.Page
{
        protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            {
                Js.Focus(this, ket);
                string Lokasi = Db.SingleString("SELECT Nama FROM " + Mi.DbPrefix + "MARKETINGJUAL..REF_BERKAS_PPJB WHERE SN='" + NoBerkas + "'");
                Js.Confirm(this,
                    "Apakah anda ingin menghapus berkas : " + Lokasi + " ?\\n"

<%@ Page Language="C#" CodeFile="LokasiKontrakEdit.aspx.cs" Inherits="ISC064.ADMINJUAL.LokasiKontrakEdit" %>
...
<html lang="en">
<head runat="server">
    <title>Edit Lokasi Penjualan</title>
    ...
    <meta name="sec" content="Lokasi Kontrak - Edit Lokasi Kontrak">
</head>
<body class="body-padding" onkeyup="if(event.keyCode==27) window.close()">
    <form id="Form1" method="post" runat="server">
        <h1 class="title title-line">Edit Lokasi Penjualan</h1>
                        ...
                        <td width="400">
                            <table cellspacing="5">
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <asp:DropDownList runat="server" ID="project" AutoPostBack="true"></asp:DropDownList></td>
                                </tr>
                                <tr>
                                    <td>Lokasi Unit
                                    </td>

<%@ Control Language="c#" Inherits="ISC064.SETTINGS.HeadLevel" CodeFile="HeadLevel.ascx.cs" %>
...
<table cellspacing="5">
	<tr>
		...
		<td style="font-size:8pt;padding-left:10px">
			ID :
			<asp:label id="notipe" runat="server" font-bold="True"></asp:label>
		</td>
		<td style="font-size:8pt;padding-left:10px">
			Nama :
		...
		<td style="font-size:8pt;padding-left:10px">
			Parent :
			<asp:label id="parent" runat="server" font-bold="True"></asp:label>
		</td>

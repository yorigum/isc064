<%@ Page Language="c#" Inherits="ISC064.COLLECTION.ReminderBelumSettle" CodeFile="ReminderBelumSettle.aspx.cs" %>

<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html>
<head>
    <title>Reminder Surat Peringatan Belum Settle</title>
    ...
    <meta name="sec" content="Reminder - Surat Peringatan Belum Settle">
</head>
<body class="body-padding" onkeyup="if(event.keyCode==27)document.getElementById('cancel').click()">
    <form id="Form1" method="post" runat="server" class="cnt">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <h1 class="title title-line">Reminder Surat Peringatan Belum Settle</h1>
        <br />

<%@ Page language="c#" Inherits="ISC064.COLLECTION.CustomerPJT" CodeFile="CustomerPJT.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="HeadCIF" Src="HeadCIF.ascx" %>
<%@ Register TagPrefix="uc1" TagName="NavCIF" Src="NavCIF.ascx" %>
<!DOCTYPE html>
<html>
	<head>
		<title>Customer Information File (Pemberitahuan Jatuh Tempo)</title>
		...
		<meta name="sec" content="Customer Information File - P. Jatuh Tempo">
	</head>
		...
		<form id="Form1" method="post" runat="server">
            ...
            <div class="tabdata">
				<div class="pad">
					...
					<br>
					<asp:table id="rpt" runat="server" cssclass="tb blue-skin" cellspacing="1" style="">

...
namespace ISC064.COLLECTION
{
	public partial class LogDetil : System.Web.UI.Page
	{
        ...
        {
            FillAkt(akt1, "MS_PJT_LOG");
            FillAkt(akt2, "MS_TUNGGAKAN_LOG");
            FillAkt(akt3, "" + Mi.DbPrefix + "MARKETINGJUAL..REF_FOLLOWUP_LOG");
            FillAkt(akt4, "MS_SKL_LOG");
            FillAkt(akt5, "" + Mi.DbPrefix + "MARKETINGJUAL..MS_FOLLOWUP_LOG");
            FillAkt(akt6, "" + Mi.DbPrefix + "MARKETINGJUAL..MS_REALISASIDENDA_LOG");
            FillAkt(akt7, "" + Mi.DbPrefix + "MARKETINGJUAL..MS_PUTIHDENDA_LOG");

...
{
	public partial class ReminderPJTBaru : System.Web.UI.Page
	{
        ...
        private void Fill()
        {
            string nav = "'<a href=\"javascript:call('''+ CONVERT(VARCHAR(50),NoPJT)+''')\">' + NoPJT + '</a>' AS PJT";
            string strSql = "SELECT "
                ...
                + " WHERE a.PrintPJT = 0 "
                + " AND (SELECT COUNT(*) FROM MS_PJT_JURNAL WHERE NoPJT = a.NoPJT) = 0"

<%@ Control Language="c#" Inherits="ISC064.COLLECTION.HeadPJT" CodeFile="HeadPJT.ascx.cs" %>
...
<table cellspacing="5">
	<tr>
		<td><a id="prev" runat="server" accesskey="," class="abtn">
            <i class="fa fa-long-arrow-left"></i> <b>Prev</b> 
        </a></td>
		...
		<td style="font-size:8pt;padding-left:10px">
			No. :
			<asp:label id="nopjt" runat="server" font-bold="True"></asp:label>
		</td>
		<td style="font-size:8pt;padding-left:10px">
			Tipe :

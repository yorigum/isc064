...
<%@ Page language="c#" Inherits="ISC064.COLLECTION.PJTRegistrasiPenghuni" CodeFile="PJTRegistrasiPenghuni.aspx.cs" %>
...
<html>
	<head>
		...
		<meta name="sec" content="P. Jatuh Tempo - Registrasi Pemberitahuan Jatuh Tempo (Tenant)">
	</head>
	<body onkeyup="if(event.keyCode==27&&confirm('Apakah anda ingin membatalkan proses registrasi?')) document.getElementById('cancel').click();">
		<form id="Form1" method="post" runat="server" class="cnt">
			...
			<h1>Registrasi Pemberitahuan Jatuh Tempo</h1>

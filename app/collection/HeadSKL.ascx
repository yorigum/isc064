<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HeadSKL.ascx.cs" Inherits="ISC064.COLLECTION.HeadSKL" %>
...
<table cellspacing="5">
	<tr>
		...
		<td style="font-size:8pt;padding-left:10px">
			No. :
			<asp:label id="noskl" runat="server" font-bold="True"></asp:label>
		</td>
		<td style="font-size:8pt;padding-left:10px">
			Ref. :

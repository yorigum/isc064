<%@ Control Language="c#" Inherits="ISC064.COLLECTION.HeadTunggakan" CodeFile="HeadTunggakan.ascx.cs" %>
...
<table cellspacing="5">
	<tr>
		...
		<td style="font-size:8pt;padding-left:10px">
			No. :
			<asp:label id="notunggakan" runat="server" font-bold="True"></asp:label>
		</td>
		<td style="font-size:8pt;padding-left:10px">
			Tipe :

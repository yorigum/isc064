...
{
    public partial class GroupingFollowUp : System.Web.UI.Page
    {
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            if (valid())
            {
                ...
                else
                {
                    ...
                    Response.Redirect("GroupingFollowUp.aspx?done=" + NoGr + "&project=" + project.SelectedValue);
                }
            }
        }
        ...
        private void Fill()
        {
            string strSql = "SELECT * FROM ISC064_MARKETINGJUAL..REF_FOLLOWUP WHERE Project = '" + project.SelectedValue + "' ORDER BY No DESC";

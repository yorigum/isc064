<%@ Page language="c#" Inherits="ISC064.COLLECTION.PJTRegistrasi" CodeFile="PJTRegistrasi.aspx.cs" %>
...
<head>
    ...
    <meta name="sec" content="P. Jatuh Tempo - Registrasi Pemberitahuan Jatuh Tempo">
</head>
    ...
    <form id="Form1" method="post" runat="server" class="cnt">
        ...
        <script type="text/javascript">
            function call(ref, tipe) {
                if (tipe == "TENANT")
                    location.href = 'PJTRegistrasiPenghuni.aspx?Ref=' + ref + '&Tipe=' + tipe;
                else
                    location.href = 'PJTRegistrasiMarketing.aspx?Ref=' + ref + '&Tipe=' + tipe;
            }
        </script>
    </form>
</body>

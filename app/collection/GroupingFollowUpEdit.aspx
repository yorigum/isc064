<%@ Page Language="C#" CodeFile="GroupingFollowUpEdit.aspx.cs" Inherits="ISC064.ADMINJUAL.GroupingFollowUpEdit" %>
...
<head>
    ...
    <meta name="sec" content="Grouping Unit - Edit Grouping Unit">
</head>
<body class="body-padding" onkeyup="if(event.keyCode==27) window.close()">
    <form id="Form1" method="post" runat="server">
        <h1 class="title title-line">Edit Grouping</h1>        
                <table cellspacing="5">
                    <tr>
                        <td width="100%"></td>
                        <td>

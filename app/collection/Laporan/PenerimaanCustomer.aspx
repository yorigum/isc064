...
<%@ Page Language="c#" Inherits="ISC064.COLLECTION.Laporan.PenerimaanCustomer" CodeFile="PenerimaanCustomer.aspx.cs" %>
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            <td>
                                                <b style="padding-right:10px;vertical-align:top">:</b>
                                                <asp:RadioButton ID="kpa1" runat="server" Text="INCLUDE TAGIHAN KPR" GroupName="kpa" Checked="True" style="padding-right:30px"></asp:RadioButton>
                                                <asp:RadioButton ID="kpa2" runat="server" Text="EXCLUDE TAGIHAN KPR" GroupName="kpa"></asp:RadioButton>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>

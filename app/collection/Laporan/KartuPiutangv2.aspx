...
<%@ Page Language="c#" Inherits="ISC064.COLLECTION.Laporan.KartuPiutangv2" CodeFile="KartuPiutangv2.aspx.cs" %>
...
<head>
    ...
    <meta name="sec" content="Laporan Kartu Piutang - Not Used">
                            ...
                            <td>
                                <p class="pparam">
                                    ...
                                    <asp:Label ID="daric" runat="server" CssClass="err"></asp:Label>&nbsp;&nbsp; 
										Sampai
										<asp:TextBox ID="sampai" runat="server" ReadOnly="True" CssClass="txt_center" Width="85"></asp:TextBox><input class="btn" onclick="popDaftarKontrak('sampai');" type="button" value="...">

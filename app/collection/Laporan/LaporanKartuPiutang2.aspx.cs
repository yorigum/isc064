    ...
    public partial class LaporanKartuPiutang2 : System.Web.UI.Page
    {
        ...
        protected void display_Click(object sender, System.EventArgs e)
        {
            ...
            for (int i = 0; i < rs.Rows.Count; i++)
            {
                ...
                c = new TableCell();
                c.Text = "<a href=\"LaporanKartuPiutang.aspx?NoKontrak=" + rs.Rows[i]["NoKontrak"].ToString() + "\">"
                    + "Screen Preview" + "</a><br>"
                    + "<a href=\"LaporanKartuPiutang.aspx?NoKontrak=" + rs.Rows[i]["NoKontrak"].ToString() + "&userid=" + Act.UserID + "&pdf=1\">"
                    + "Export PDF" + "</a><br>"
                    + "<a href=\"LaporanKartuPiutang.aspx?NoKontrak=" + rs.Rows[i]["NoKontrak"].ToString() + "&Excel=1\">Export to Excel</a>";
                r.Cells.Add(c);

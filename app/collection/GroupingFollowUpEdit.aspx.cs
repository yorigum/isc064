...
{
    public partial class GroupingFollowUpEdit : System.Web.UI.Page
    {
        ...
        private void Fill()
        {
            ...
            btndel.Attributes["onclick"] = "location.href='GroupingFollowUpDel.aspx?No=" + No + "'";
        ...
        {
            Save();
            Response.Redirect("GroupingFollowUpEdit.aspx?done=1&NoJenis=" + No);
        }

<%@ Page language="c#" Inherits="ISC064.KPA.ReminderOTS1" CodeFile="ReminderOTS1.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html>
<head>
    <title>OTS Belum Ditentukan </title>
    ...
    <meta name="sec" content="Reminder - OTS Belum Ditentukan">
</head>
<body class="body-padding" onkeyup="if(event.keyCode==27)document.getElementById('cancel').click()">
    <form id="Form1" method="post" runat="server" class="cnt">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <h1 class="title title-line">Reminder OTS Belum Ditentukan </h1>
        <br />

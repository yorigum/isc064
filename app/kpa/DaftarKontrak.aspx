<%@ Page language="c#" Inherits="ISC064.KPA.DaftarKontrak" CodeFile="DaftarKontrak.aspx.cs" %>
<!DOCTYPE html>
<html>
<head>
...
<body class="pop" onkeyup="if(event.keyCode==27){window.close()}"
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <script type="text/javascript">
            ...
            function callkontrakproject(nomor, project) {
                window.parent.callkontrakproject(nomor, project);
                window.parent.globalclose();
            }

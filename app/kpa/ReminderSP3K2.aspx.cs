...
{
    public partial class ReminderSP3K2   : System.Web.UI.Page
    {
        ...
        private void Fill()
        {
            ...
            string strSql = "SELECT "
                    ...
                    + ",BankKPR AS Bank"
                    + ",CONVERT(VARCHAR,TargetLPA,106) AS Wawancara"
                    + ",CONVERT(VARCHAR,TargetSP3K,106) AS Target"
                    + " FROM MS_KONTRAK"

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintRealisasi.aspx.cs" Inherits="ISC064.KPA.PrintRealisasi" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%@ Reference Control="~/PrintRealisasiTemplate.ascx" %>
<html>
	<head>
		<title>Print Realisasi Tagihan KPR</title>
		...
		<meta name="sec" content="Print Realisasi Tagihan KPR">
		<style type="text/css">
		#p td
		{
			font-size: 10pt;
	...
	<body onkeyup="if(event.keyCode==27&&document.getElementById('cancel')){document.getElementById('cancel').click()}else if(event.keyCode==27){document.getElementById('cancel2').click()}">
		...
		<form id="Form1" method="post" runat="server">
			<div id="reprint" runat="server">
				...
				<p style="padding:5">
					Jenis Dokumen : <u style="font:bold 10pt">Realisasi Tagihan KPR</u>
					<br>

<%@ Page Language="c#" Inherits="ISC064.KPA.KontrakEdit" CodeFile="KontrakEdit.aspx.cs" %>
...
<body onkeyup="if(event.keyCode==27) document.getElementById('cancel').click()">
    <form id="Form1" method="post" runat="server">
        <div class="content-header">
            <uc1:NavKontrakEdit ID="NavKontrak1" runat="server" Aktif="1"></uc1:NavKontrakEdit>
        </div>
        <div class="tabdata">
            <div class="pad">
                <uc1:Head ID="HeadKontrak2" runat="server"></uc1:Head>
                        ...
                        <tr valign="top">
                            <td >
                                <table cellspacing="5">
                                    ...
                                    <tr>
                                        <td>
                                            <%--<a id="aKey" runat="server">--%><b>No. Kontrak</b>
                                        </td>
                                        <td>:
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="nkm" runat="server" Width="200" CssClass="txt" ReadOnly="true"></asp:TextBox><asp:Label
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:RadioButtonList ID="nokused" runat="server">
                                                ...
                                                <asp:ListItem Value="0" Selected="True" Enabled="false">System</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:RadioButtonList ID="titipjual" runat="server" RepeatDirection="Horizontal">
                                                <asp:ListItem Value="1" Enabled="false">Titip Jual</asp:ListItem>
                                                <asp:ListItem Value="0" Enabled="false">Non Titip Jual</asp:ListItem>
                                            </asp:RadioButtonList>
                                    ...
                                    <tr>
                                        ...
                                        <asp:TextBox ID="tglinv" runat="server" Width="100px" CssClass="txt_center" ReadOnly="true"></asp:TextBox>
                                            <input type="button" value="&#xf073;" style="font-family: 'fontawesome'" class="btn" onclick="openCalendar('tglinv')" aria-readonly="true" />
                                            <br />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="noqueue" runat="server" Width="150" CssClass="txt_center" ReadOnly="true"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <nobr><asp:textbox id="tglkontrak" runat="server" width="85" cssclass="txt_center" ReadOnly="true"></asp:textbox>
								<input type="button" value="&#xf073;" style="font-family: 'fontawesome'" class="btn" onclick="openCalendar('tglkontrak')" aria-disabled="true" />
												</nobr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="targetst" runat="server" Width="85" CssClass="txt_center" ReadOnly="true">1 Jan 2010</asp:TextBox>
                                            <input type="button" value="&#xf073;" style="font-family: 'fontawesome'" class="btn" onclick="openCalendar('targetst')" aria-disabled="true" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="agent" runat="server" Width="300" CssClass="ddl" Enabled="false">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><asp:TextBox ID="reffcust" runat="server" Width="300" ReadOnly="true"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td><b>Bank Refferator</b></td>
                                        <td>:</td>
                                        <td><asp:TextBox ID="bankreff" runat="server" Width="300" ReadOnly="true"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td><b>A/N Bank</b></td>
                                        <td>:</td>
                                        <td><asp:TextBox ID="anreff" runat="server" Width="300" ReadOnly="true"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td><b>No Rek. Refferator</b></td>
                                        <td>:</td>
                                        <td><asp:TextBox ID="norekreff" runat="server" Width="300" ReadOnly="true"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td><b>NPWP Refferator</b></td>
                                        <td>:</td>
                                        <td><asp:TextBox ID="npwpreff" runat="server" Width="300" ReadOnly="true"></asp:TextBox></td>
                                    </tr>
                                    <tr id="reff" runat="server" visible="false" style="display: none;">
                                        ...
                                        <td>
                                            <asp:DropDownList ID="agentreff" runat="server" Width="300" CssClass="ddl" Enabled="false">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:RadioButtonList ID="JenisPPN" runat="server" RepeatDirection="Horizontal" Enabled="false">
                                    ...
                                    <tr style="display: none">
                                        ...
                                        <td>
                                            <asp:RadioButtonList ID="jeniskpr" runat="server" RepeatDirection="Horizontal">
                                                <asp:ListItem Value="0">KPA</asp:ListItem>
                                                <asp:ListItem Value="1">NON-KPA</asp:ListItem>
                                            </asp:RadioButtonList>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlTujuan" runat="server" AutoPostBack="true" Enabled="false">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="focounter" runat="server" Width="40" CssClass="txt_center" ReadOnly="true">1</asp:TextBox>&nbsp;x&nbsp;Angsuran
                                        <asp:TextBox ID="fo" runat="server" CssClass="txt_num" ReadOnly="true">0</asp:TextBox><asp:Label
                                            ID="foc" runat="server" CssClass="err"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr id="tra" runat="server" style="display: none">
                                        <td>
                                            <b>Nilai Realisasi KPA</b>
                                        </td>
                                        <td>:
                                        </td>
                                        <td>
                                    ...
                                    <tr id="trk" runat="server">
                                        ...
                                        <td>
                                            ...
                                            <input type="button" value="&#xf073;" style="font-family: 'fontawesome'" class="btn" onclick="openCalendar('tglkembali')" />
                                ...
                                <table cellspacing="5">
                                    <tr>
                                        ...
                                        <td colspan="3" align="right">
                                            <asp:TextBox ID="skema" Width="90%" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>

<%@ Page language="c#" Inherits="ISC064.KPA.ReminderWawancara2" CodeFile="ReminderWawancara2.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html>
<head>
    <title>Wawancara Sudah Dijadwalkan Belum Selesai </title>
    ...
    <meta name="sec" content="Reminder - Wawancara Sudah Dijadwalkan Belum Selesai ">
</head>
<body class="body-padding" onkeyup="if(event.keyCode==27)document.getElementById('cancel').click()">
    <form id="Form1" method="post" runat="server" class="cnt">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <h1 class="title title-line">Wawancara Sudah Dijadwalkan Belum Selesai </h1>
        <br />

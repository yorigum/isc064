<%@ Page language="c#" Inherits="ISC064.KPA.ReminderWawancara1" CodeFile="ReminderWawancara1.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html>
<head>
    <title>Reminder Wawancara Belum Ditentukan</title>
    ...
    <meta name="sec" content="Reminder - Wawancara Belum Ditentukan">
</head>
<body class="body-padding" onkeyup="if(event.keyCode==27)document.getElementById('cancel').click()">
    <form id="Form1" method="post" runat="server" class="cnt">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <h1 class="title title-line">Reminder Wawancara Belum Ditentukan</h1>
        <br />

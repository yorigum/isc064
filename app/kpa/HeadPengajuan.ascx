<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HeadPengajuan.ascx.cs" Inherits="ISC064.KPA.HeadPengajuan" %>
...
<table cellspacing="5">
	<tr>
		...
		<td style="font-size:8pt;padding-left:10px">
			No. Pengajuan :
			<asp:label id="nopengajuan" runat="server" font-bold="True"></asp:label>
		</td>
		<td style="font-size:8pt;padding-left:10px">
			Diajukan Oleh :

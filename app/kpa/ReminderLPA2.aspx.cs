...
{
    public partial class ReminderLPA2 : System.Web.UI.Page
    {
        ...
        private void Fill()
        {
            string nav = "'<a href=\"javascript:popEditLPA('''+CONVERT(varchar(50),NoKontrak)+''');\">'+ NoKontrak +'</a>' AS Kontrak";

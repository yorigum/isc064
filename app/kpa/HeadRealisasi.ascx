<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HeadRealisasi.ascx.cs" Inherits="ISC064.KPA.HeadRealisasi" %>
...
<table cellspacing="5">
	<tr>
		...
		<td style="font-size:8pt;padding-left:10px">
			No. Realisasi :
			<asp:label id="norealisasi" runat="server" font-bold="True"></asp:label>
		</td>
		<td style="font-size:8pt;padding-left:10px">
			Kasir :
			<asp:label id="userid" runat="server" font-bold="True"></asp:label>
		</td>
		<td style="font-size:8pt;padding-left:10px">
			Tgl. Input :

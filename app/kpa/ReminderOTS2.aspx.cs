...
{
    public partial class ReminderOTS2 : System.Web.UI.Page
    {
        ...
        private void Fill()
        {
            string nav = "'<a href=\"javascript:popEditOTS('''+CONVERT(varchar(50),NoKontrak)+''');\">'+ NoKontrak +'</a>' AS Kontrak";

    ...
    public partial class KontrakEdit : System.Web.UI.Page
{
        ...
        private void Fill()
        {
            ...
            aStatus.HRef = "javascript:openModal('../marketingjual/KontrakStatus.aspx?NoKontrak=" + NoKontrak + "','500','500')";
            ...
            btndel.Attributes["onclick"] = "location.href='../marketingjual/KontrakDel.aspx?NoKontrak=" + NoKontrak + "'";
            ...
            else
            {
                ...
                if (rs.Rows[0]["CaraBayar"].ToString() == "KPA")
                {
        ...
        private bool valid()
        {
            ...
            if (!x)
                Js.Alert(
                    ...
                    + "2. Nilai Realisasi KPA, Nilai Klaim, Total Pelunasan pada saat Batal, Nilai Kembali harus berupa angka."

<%@ Page language="c#" Inherits="ISC064.KPA.ReminderSP3K1" CodeFile="ReminderSP3K1.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html>
<head>
    <title>Reminder SP3K Belum Ditentukan</title>
    ...
    <meta name="sec" content="Reminder - Reminder SP3K Belum Ditentukan">
</head>
<body class="body-padding" onkeyup="if(event.keyCode==27)document.getElementById('cancel').click()">
    <form id="Form1" method="post" runat="server" class="cnt">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <h1 class="title title-line">Reminder SP3K Belum Ditentukan</h1>
        <br />
        <asp:GridView ID="tb" runat="server" SkinID="pager" OnPageIndexChanging="tb_PageIndexChanging">
            <Columns>
                ...
                <asp:BoundField HeaderText="Tgl. Wawancara" DataField="Target" ItemStyle-VerticalAlign="Top" />
            </Columns>
        </asp:GridView>

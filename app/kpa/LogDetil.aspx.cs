...
namespace ISC064.KPA
{
	public partial class LogDetil : System.Web.UI.Page
	{
		...
		{
			FillAkt(akt1 , "MS_KONTRAK_LOG");
            FillAkt(akt2, "REF_BANKKPA_LOG");
            FillAkt(akt3, "REF_RETENSI_LOG");
            FillAkt(akt4, "ISC064_FINANCEAR..MS_PENGAJUAN_KPA_LOG");
            FillAkt(akt5, "ISC064_FINANCEAR..MS_REAL_KPA_LOG");

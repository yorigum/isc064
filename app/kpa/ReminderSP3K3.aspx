<%@ Page language="c#" Inherits="ISC064.KPA.ReminderSP3K3" CodeFile="ReminderSP3K3.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html>
<head>
    <title>Reminder SP3K Sudah Diajukan Belum Diputuskan</title>
    ...
    <meta name="sec" content="Reminder - SP3K Sudah Diajukan Belum Diputuskan">
</head>
<body class="body-padding" onkeyup="if(event.keyCode==27)document.getElementById('cancel').click()">
    <form id="Form1" method="post" runat="server" class="cnt">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <h1 class="title title-line">Reminder SP3K Sudah Diajukan Belum Diputuskan</h1>
        <br />
        <asp:GridView ID="tb" runat="server" SkinID="pager" OnPageIndexChanging="tb_PageIndexChanging">
            <Columns>
                ...
                <asp:BoundField HeaderText="Tgl. Pengajuan SP3k" DataField="Pengajuan" ItemStyle-VerticalAlign="Top" />
            </Columns>
        </asp:GridView>

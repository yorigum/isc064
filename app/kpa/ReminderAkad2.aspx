<%@ Page language="c#" Inherits="ISC064.KPA.ReminderAkad2" CodeFile="ReminderAkad2.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html>
<head>
    <title>Reminder Akad Sudah Dijadwalkan Belum Selesai</title>
    ...
    <meta name="sec" content="Reminder - Akad Sudah Dijadwalkan Belum Selesai">
</head>
<body class="body-padding" onkeyup="if(event.keyCode==27)document.getElementById('cancel').click()">
    <form id="Form1" method="post" runat="server" class="cnt">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <h1 class="title title-line">Reminder Akad Sudah Dijadwalkan Belum Selesai </h1>
        <br />
        <asp:GridView ID="tb" runat="server" SkinID="pager" OnPageIndexChanging="tb_PageIndexChanging">
            <Columns>
                ...
                <asp:BoundField HeaderText="Target Akad" DataField="Target" ItemStyle-VerticalAlign="Top" />

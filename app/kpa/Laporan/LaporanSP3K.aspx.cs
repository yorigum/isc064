...
{
    public partial class LaporanSP3K : System.Web.UI.Page
    {
        ...
        protected void pdf_Click(object sender, System.EventArgs e)
        {
            ...
            string nfilename = "LapSP3K" + NoAttachment + ".pdf";
            ...
            string save = Mi.PathFilePDFReport + "LapSP3K" + rs.Rows[0]["AttachmentID"] + ".pdf";
            ...
            string link = Mi.PathAlamatWeb + "kpa/LaporanPDF/PDFSP3K.aspx?id=" + rs.Rows[0]["AttachmentID"] + "&tgl=" + tgl + "&status=" + status + "&hasil=" + hasil + "&rek=" + rek + "&lokasi=" + Lokasi + "&project=" + Project + "&pers=" + pers.SelectedValue + "";

...
{
    public partial class LaporanOTS : System.Web.UI.Page
    {
        ...
        private void Header()
        {
            ...
            Rpt.SubJudul(
                x, "Status OTS : " + ddlStatus.SelectedItem.Text
                );

            Rpt.SubJudul(
                x, "Hasil OTS : " + ddlHasil.SelectedItem.Text
                );
        ...
        private void Fill()
        {
            ...
            if (ddlStatus.SelectedIndex != 0)
            {
                if (ddlStatus.SelectedItem.Text == "BELUM DITENTUKAN")
                    ...
                    Status = " AND StatusOTS = '" + ddlStatus.SelectedItem.Text + "'";
            }

            string Hasil = "";
            if (ddlHasil.SelectedIndex != 0)
            {
                Hasil = " AND HasilOTS = '" + ddlHasil.SelectedItem.Text + "'";
            }
        ...
        protected void pdf_Click(object sender, System.EventArgs e)
        {
            ...
            string nfilename = "LapOTS" + NoAttachment + ".pdf";
            ...
            string save = Mi.PathFilePDFReport + "LapOTS" + rs.Rows[0]["AttachmentID"] + ".pdf";
            ...
            string link = Mi.PathAlamatWeb + "kpa/LaporanPDF/PDFOTS.aspx?id=" + rs.Rows[0]["AttachmentID"] + "&tgl=" + tgl + "&status=" + status + "&hasil=" + hasil + "&rek=" + rek + "&lokasi=" + Lokasi + "&project=" + Project + "&pers=" + pers.SelectedValue + "";

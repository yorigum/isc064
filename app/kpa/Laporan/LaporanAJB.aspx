<%@ Page Language="c#" Inherits="ISC064.KPA.Laporan.LaporanAJB" CodeFile="LaporanAJB.aspx.cs" %>
    ...
    <form id="Form1" method="post" runat="server">
            ...
            <tr>
                <td>
                    <div class="underline" runat="server">
                        ...
                        <h1 id="judul" runat="server" class="title">Laporan AJB
                        </h1>
                    </div>
                    <div class="form-model">
                        <div class="form-inline col">
                            <div class="pparam">
                                <p class="lbl" style="width: 150px">Lokasi<b style="padding-left:95px">:</b></p>
                                <asp:ListBox ID="lokasi" runat="server" Width="200" CssClass="ddl" Rows="10" style="margin-left:50px">
                        ...
                        <div class="form-inline col">
                            <div class="pparam">
                                <p class="lbl" style="width: 150px">View By<b style="padding-left:85px;">:</b></p>
                                <asp:RadioButton ID="tbTgl" runat="server" Text="Tanggal AJB" Font-Bold="True" Font-Size="10" GroupName="tgl"
                                    Checked="True" style="margin-left:50px;padding-right:40px"></asp:RadioButton>                               
                            </div>
                        </div>
                        <div class="form-inline col">
                            <table>
                                <tr>
                                    ...
                                    <td style="float: none; min-width: 0px;">
                                        <p class="lbl" style="margin-left:10px;margin-left:70px;font-size:12px">Dari</p>
                                    </td>
                                    <td style="float: none; min-width: 0px;">
                            ...
                            <div class="form-inline col">
                            <div class="pparam">
                                <p class="lbl" style="width: 150px">Status AJB<b style="padding-left:65px;">:</b></p>
                                <asp:DropDownList ID="ddlStatus" runat="server" CssClass="select-dropdown" Width="200"  style="margin-left:50px" Font-Size="12px">
                            ...
                            <div class="form-inline col">
                            <div class="pparam">
                                <p class="lbl" style="width: 150px">Project<b style="padding-left:88px;">:</b></p>
                                <asp:DropDownList ID="project" runat="server" CssClass="select-dropdown" Width="200"  style="margin-left:50px" Font-Size="12px">
                                    <asp:ListItem>SEMUA</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div class="form-inline col">
                            <div class="pparam">
                                <p class="lbl" style="width: 150px">Perusahaan<b style="padding-left:50px;">:</b></p>
                                <asp:DropDownList ID="pers" runat="server" CssClass="select-dropdown" Width="200"  style="margin-left:50px" Font-Size="12px">
                                    <asp:ListItem>SEMUA</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
        ...
        <asp:Table ID="rpt" runat="server" CssClass="tb blue-skin" CellSpacing="1">
            <asp:TableRow VerticalAlign="Bottom">
                ...
                <asp:TableHeaderCell HorizontalAlign="Left" BackColor="#1E90FF" ForeColor="White">Status AJB</asp:TableHeaderCell>
                ...
                <asp:TableHeaderCell HorizontalAlign="Left" BackColor="#1E90FF" ForeColor="White">Nama Notaris</asp:TableHeaderCell>
                <asp:TableHeaderCell HorizontalAlign="Left" BackColor="#1E90FF" ForeColor="White">No. Roya</asp:TableHeaderCell>
            </asp:TableRow>
        </asp:Table>
    </form>
</body>

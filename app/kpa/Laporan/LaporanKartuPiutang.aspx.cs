    ...
    public partial class LaporanKartuPiutang : System.Web.UI.Page
    {
        ...
        private void Fill()
        {
            ...
            for (int i = 0; i < rs.Rows.Count; i++)
            {
                ...
                l = new Label();
                l.Text = "<tr><td colspan='8'><h1 class='title'></h1></td></tr>";
                report.Controls.Add(l);
                ...
                //Nilai Kontrak
                l = new Label();
                l.Text = "<td width='150px'>Nilai Kontrak</td><td>:</td><td align='right'>" + Cf.Num(rs.Rows[i]["NilaiKontrak"]) + "</td></tr>";
                report.Controls.Add(l);
                ...
                //NILAI KPR
                l = new Label();
                decimal NilaiKPA = Db.SingleDecimal("SELECT ISNULL(SUM(NilaiTagihan),0) FROM ISC064_MARKETINGJUAL..MS_TAGIHAN WHERE NoKontrak = '" + Cf.Str(NoKontrak) + "'");
                l.Text = "<td>Nilai KPR</td><td>:</td><td align='right'>" + Cf.Num(NilaiKPA) + "</td>";
                report.Controls.Add(l);
                ...
                //TAGIHAN KPR
                l = new Label();
                decimal Tagihan = Db.SingleDecimal("SELECT ISNULL(SUM(NilaiTagihan),0) FROM ISC064_MARKETINGJUAL..MS_TAGIHAN WHERE NoKontrak = '" + Cf.Str(NoKontrak) + "'");
                l.Text = "<td>Tagihan KPR</td><td>:</td><td align='right'>" + Cf.Num(Tagihan) + "</td>";
                report.Controls.Add(l);
                ...
                //SISA
                l = new Label();
                decimal Biaya = Tagihan - NilaiKPA; //Db.SingleDecimal("SELECT ISNULL(SUM(NilaiTagihan),0) FROM ISC064_MARKETINGJUAL..MS_TAGIHAN WHERE NoKontrak = '" + Cf.Str(NoKontrak) + "' AND Tipe IN ('ADM')");
                l.Text = "<td>Sisa</td><td>:</td><td align='right'>" + Cf.Num(Biaya) + "</td></tr>";
                report.Controls.Add(l);
        ...
        protected void FillTagihan(string NoKontrak)
        {
            ...
            x.Append("</tr>");
            x.Append("<tr>");
            x.Append("<th style='border-right: 1px ; border-bottom: 1px;background-color:#1E90FF; color:white'>Tgl. Jatuh Tempo</th>");
            x.Append("<th style='border-right: 1px ; border-bottom: 1px;background-color:#1E90FF; color:white'>Nilai</th>");
            x.Append("<th style='border-right: 1px ; border-bottom: 1px;background-color:#1E90FF; color:white'>Tgl. Cair</th>");
            ...
            for (int i = 0; i < rs.Rows.Count; i++)
            {
                ...
                if (i == (rs.Rows.Count - 1))
                {
                    ...
                    x.Append("<tr>");
                    x.Append("<td colspan='2' style='border-right: 1px ;'><b>JUMLAH PIUTANG</b></td>");
                    ...
                    x.Append("<tr>");
                    x.Append("<td colspan='2' style='border-right: 1px ;'><b>Pencairan</b></td>");
                    x.Append("<td style='border-right: 1px ;'>&nbsp;</td>");
                    ...
                    x.Append("<tr>");
                    x.Append("<td colspan='2' style='border-right: 1px ;'><b>Sisa Piutang</b></td>");
                    x.Append("<td style='border-right: 1px ;'>&nbsp;</td>");

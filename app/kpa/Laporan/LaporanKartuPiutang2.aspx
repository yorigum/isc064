...
<%@ Page language="c#" Inherits="ISC064.KPA.Laporan.LaporanKartuPiutang2" CodeFile="LaporanKartuPiutang2.aspx.cs" %>
<!DOCTYPE html>
<html lang="en">
	<head>
	...
	<body class="body-padding">
		<form id="Form1" method="post" runat="server" class="cnt">
			...
			<h1 class="title title-line">Laporan Kartu Piutang KPR</h1>
			<br>
			<table cellspacing="5">
				<tr>

...
<%@ Page Language="c#" Inherits="ISC064.KPA.Laporan.OTS" CodeFile="PDFOTS.aspx.cs" %>
    ...
    <form id="Form1" method="post" runat="server">
            ...
            <table id="param" runat="server" width="100%" cellspacing="3">
                <tr>
                    <td colspan="2">
                        ...
                        <h1 id="judul" runat="server" class="title title-line">Laporan OTS
                        </h1>
                    </td>
                </tr>
            </table>
        ...
        <asp:Table ID="rpt" runat="server" CssClass="tb blue-skin" CellSpacing="1">
            <asp:TableRow VerticalAlign="Bottom">
                ...
                <asp:TableHeaderCell HorizontalAlign="Left">Status OTS</asp:TableHeaderCell>
                <asp:TableHeaderCell HorizontalAlign="Left">Target OTS</asp:TableHeaderCell>
                <asp:TableHeaderCell HorizontalAlign="Left">Tgl. Hasil OTS</asp:TableHeaderCell>

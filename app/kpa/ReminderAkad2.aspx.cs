...
{
    public partial class ReminderAkad2  : System.Web.UI.Page
    {
        ...
        private void Fill()
        {
            string nav = "'<a href=\"javascript:popEditAkad('''+CONVERT(varchar(50),NoKontrak)+''');\">'+ NoKontrak +'</a>' AS Kontrak";
            string strSql = "SELECT "
                    ...
                    + ",BankKPR AS Bank"
                    + ",CONVERT(VARCHAR,TargetAkad,106) AS Target"
                    + ",HasilSP3K AS Hasil"
                    + " FROM MS_KONTRAK"

...
{
    public partial class ReminderWawancara2 : System.Web.UI.Page
    {
        ...
        private void Fill()
        {
            string nav = "'<a href=\"javascript:popEditWawancara('''+CONVERT(varchar(50),NoKontrak)+''');\">'+ NoKontrak +'</a>' AS Kontrak";
            string strSql = "SELECT "
                    ...
                    + " AND StatusWawancara = 'DIJADWALKAN'"
                    + " AND CaraBayar = 'KPR'"
                    + " AND StatusBerkas = 1"

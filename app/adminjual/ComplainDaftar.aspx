...
<%@ Page Language="c#" Inherits="ISC064.ADMINJUAL.ComplainDaftar" CodeFile="ComplainDaftar.aspx.cs" %>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="body-padding">
    ...
    <h1 class="title title-line">
        Pendaftaran Jenis Complain Baru</h1>
    <br />
    <table cellspacing="0">
        <tr valign="top">
            ...
            <td>
                ...
                <table cellspacing="5">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="nocomplain" runat="server" CssClass="txt" Width="65" Font-Bold="True"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="judul" runat="server" CssClass="txt" Width="200" MaxLength="100"></asp:TextBox>

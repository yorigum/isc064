<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HeadCF.ascx.cs" Inherits="ISC064.ADMINJUAL.HeadCF" %>
...
<table cellspacing="5">
	<tr>
		...
		<td style="font-size:8pt;padding-left:10px">
			ID :
			<asp:label id="lvl" runat="server" font-bold="True"></asp:label>
		</td>
		<td style="font-size:8pt;padding-left:10px">
			Level :
			<asp:label id="ket" runat="server" font-bold="True"></asp:label>
		</td>
	</tr>
</table>

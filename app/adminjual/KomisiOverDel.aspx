<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KomisiOverDel.aspx.cs" Inherits="ISC064.ADMINJUAL.KomisiOverDel" %>
<!DOCTYPE html>
<html lang="en">
	<head>
		<title>Delete Komisi Overriding</title>
	...
	<body onkeyup="if(event.keyCode==27) history.back(-1)">
		<form id="Form1" method="post" runat="server">
			<div id="frm" runat="server">
				...
				<h1>Delete Komisi Overriding</h1>
				<br/>
				Keterangan :

<%@ Page Language="c#" Inherits="ISC064.ADMINJUAL.DaftarGimmick" CodeFile="DaftarGimmick.aspx.cs" %>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="metode" runat="server" CssClass="ddl form-control">
                            ...
                            <asp:ListItem>Gimmick Aktif</asp:ListItem>
                            <asp:ListItem>Gimmick Inaktif</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td>

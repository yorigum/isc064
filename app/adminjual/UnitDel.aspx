...
<%@ Page Language="c#" Inherits="ISC064.ADMINJUAL.UnitDel" CodeFile="UnitDel.aspx.cs" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Label ID="nodel" runat="server" Visible="false">
				...
				<div class="plike">
					...
					<ul>
						<li>
							Unit tersebut masih memiliki waiting list reservasi
						</li>
						<li>
							Unit tersebut sudah memiliki kontrak
						</li>
					</ul>
				</div>
        </asp:Label>

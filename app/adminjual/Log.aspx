<%@ Page Language="c#" Inherits="ISC064.ADMINJUAL.Log" CodeFile="Log.aspx.cs" %>
        ...
        <table style="border: 1px solid #DCDCDC" cellspacing="5">
            <tr>
                ...
                <td>
                    ...
                    <asp:Button ID="xls" AccessKey="e" runat="server" Text="Excel" CssClass="btn btn-green" Width="80px" OnClick="xls_Click"></asp:Button>
                </td>
            </tr>
            <tr>
                <td>Keyword</td>
            ...
            <tr>
                <td colspan="15">
                    <asp:RadioButtonList ID="tb" runat="server" RepeatDirection="Horizontal" RepeatColumns="6" Font-Bold="True" CssClass="radio"
                         OnSelectedIndexChanged="tb_SelectedIndexChanged" AutoPostBack="true">
                        <asp:ListItem Value="MS_UNIT_LOG" class="igroup-radio">UNIT</asp:ListItem>
                        <asp:ListItem Value="MS_AGENT_LOG" class="igroup-radio">MARKETING</asp:ListItem>
                        <asp:ListItem Value="ISC064_MARKETINGJUAL..REF_SKEMA_LOG" class="igroup-radio">SKEMA CARA BAYAR</asp:ListItem>
                        <asp:ListItem Value="ISC064_MARKETINGJUAL..REF_AGENT_TIPE_LOG" class="igroup-radio">TIPE SALES</asp:ListItem>
                        <asp:ListItem Value="ISC064_MARKETINGJUAL..REF_AGENT_LEVEL_LOG" class="igroup-radio">LEVEL SALES</asp:ListItem>
                    </asp:RadioButtonList>
                    <asp:DropDownList ID="href" runat="server" Visible="False">
                        <asp:ListItem Value="MS_UNIT_LOG">UnitEdit.aspx?NoStock='%pk%'</asp:ListItem>
                        <asp:ListItem Value="MS_AGENT_LOG">AgentEdit.aspx?NoAgent='%pk%'</asp:ListItem>
                        <asp:ListItem Value="ISC064_MARKETINGJUAL..REF_SKEMA_LOG">SkemaEdit.aspx?id='%pk%'</asp:ListItem>
                        <asp:ListItem Value="ISC064_MARKETINGJUAL..REF_AGENT_TIPE_LOG">TipeSalesEdit.aspx?id='%pk%'</asp:ListItem>
                        <asp:ListItem Value="ISC064_MARKETINGJUAL..REF_AGENT_LEVEL_LOG">LevelSalesEdit.aspx?id='%pk%'</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
        </table>

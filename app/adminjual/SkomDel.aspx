<%@ Page language="c#" Inherits="ISC064.ADMINJUAL.SkomDel" CodeFile="SkomDel.aspx.cs" %>
	...
	<body class="default-content" onkeyup="if(event.keyCode==27) history.back(-1)">
		<form id="Form1" method="post" runat="server">
			<div id="frm" runat="server">
				...
				<h1>Delete Skema Komisi</h1>
				<br>
				Keterangan :
				<asp:textbox id="ket" runat="server" cssclass="txt" width="400"></asp:textbox>
				<asp:button id="delbtn" runat="server" cssclass="btn" text="Delete" onclick="delbtn_Click"></asp:button>
			</div>

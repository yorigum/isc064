<%@ Page Language="c#" Inherits="ISC064.ADMINJUAL.LevelSalesEdit" CodeFile="LevelSalesEdit.aspx.cs" %>
                        ...
                        <td width="400">
                            <table cellspacing="5">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="nama" runat="server" Width="150" CssClass="txt" MaxLength="50"></asp:TextBox>

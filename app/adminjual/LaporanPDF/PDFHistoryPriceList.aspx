...
<%@ Page Language="c#" Inherits="ISC064.ADMINJUAL.Laporan.PriceList" CodeFile="PDFHistoryPriceList.aspx.cs" %>

<!DOCTYPE html>
<html lang="en">
<head>
    <title>History Price List</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Table ID="rpt" runat="server" CssClass="tb blue-skin" CellSpacing="1">
              <asp:TableRow VerticalAlign="Bottom">
                ...
                <asp:TableHeaderCell HorizontalAlign="Left">No. Stock</asp:TableHeaderCell>

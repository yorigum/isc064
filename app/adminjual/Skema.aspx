<%@ Page Language="c#" Inherits="ISC064.ADMINJUAL.Skema" CodeFile="Skema.aspx.cs" %>
                ...
                <td>
                    ...
                    <table cellspacing="5">
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td>
                                <asp:RadioButton class="radio" ID="bfrupiah" runat="server" Text="Rp" GroupName="bftipe" Checked="True"></asp:RadioButton></td>
                            <td>
                                <asp:RadioButton class="radio" ID="bfpersen" runat="server" Text="%" GroupName="bftipe"></asp:RadioButton></td>
                            <td>&nbsp;</td>
                            <td>
                                <asp:TextBox ID="bfjumlah" runat="server" CssClass="txt_num">15,000,000</asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td>
                                <asp:RadioButton class="radio" ID="dprupiah" runat="server" Text="Rp" GroupName="dptipe"></asp:RadioButton></td>
                            <td>
                                <asp:RadioButton class="radio" ID="dppersen" runat="server" Text="%" GroupName="dptipe" Checked="True"></asp:RadioButton></td>
                            <td>&nbsp;</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td>
                                <asp:RadioButton class="radio" ID="angrupiah" runat="server" Text="Rp" GroupName="angtipe"></asp:RadioButton></td>
                            <td>
                                <asp:RadioButton class="radio" ID="angpersen" runat="server" Text="%" GroupName="angtipe" Checked="True"></asp:RadioButton></td>
                            <td>&nbsp;</td>
                            <td>
                    ...
                    <table cellspacing="5">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RadioButton class="radio" ID="bfbln1" runat="server" Text="Bln" GroupName="bf1"></asp:RadioButton></td>
                            <td>
                                <asp:RadioButton class="radio" ID="bfhari1" runat="server" Text="Hari" GroupName="bf1" Checked="True"></asp:RadioButton></td>
                            <td>&nbsp;</td>
                            <td>
                                <asp:TextBox ID="bflama2" runat="server" Width="40" CssClass="txt_center">0</asp:TextBox></td>
                            <td>
                                <asp:RadioButton class="radio" ID="bfbln2" runat="server" Text="Bln" GroupName="bf2"></asp:RadioButton></td>
                            <td>
                                <asp:RadioButton class="radio" ID="bfhari2" runat="server" Text="Hari" GroupName="bf2" Checked="True"></asp:RadioButton>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RadioButton class="radio" ID="dpbln1" runat="server" Text="Bln" GroupName="dp1" Checked="True"></asp:RadioButton></td>
                            <td>
                                <asp:RadioButton class="radio" ID="dphari1" runat="server" Text="Hari" GroupName="dp1"></asp:RadioButton></td>
                            <td>&nbsp;</td>
                            <td>
                                <asp:TextBox ID="dplama2" runat="server" Width="40" CssClass="txt_center">1</asp:TextBox></td>
                            <td>
                                <asp:RadioButton class="radio" ID="dpbln2" runat="server" Text="Bln" GroupName="dp2" Checked="True"></asp:RadioButton></td>
                            <td>
                                <asp:RadioButton class="radio" ID="dphari2" runat="server" Text="Hari" GroupName="dp2"></asp:RadioButton>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:RadioButton class="radio" ID="angbln1" runat="server" Text="Bln" GroupName="ang1" Checked="True"></asp:RadioButton></td>
                            <td>
                                <asp:RadioButton class="radio" ID="anghari1" runat="server" Text="Hari" GroupName="ang1"></asp:RadioButton></td>
                            <td>&nbsp;</td>
                            <td>
                                <asp:TextBox ID="anglama2" runat="server" Width="40" CssClass="txt_center">1</asp:TextBox></td>
                            <td>
                                <asp:RadioButton class="radio" ID="angbln2" runat="server" Text="Bln" GroupName="ang2" Checked="True"></asp:RadioButton></td>
                            <td>
                                <asp:RadioButton class="radio" ID="anghari2" runat="server" Text="Hari" GroupName="ang2"></asp:RadioButton>
                    ...
                    <table cellspacing="5">
                        <tr>
                            <td valign="top">Booking Fee dipotong di :
									<br>
                                <asp:RadioButton class="radio" ID="dp1potong" runat="server" GroupName="bfpotong" Text="DP 1" Checked="True"></asp:RadioButton>
                                &nbsp;&nbsp;
									<asp:RadioButton class="radio" ID="ang1potong" runat="server" GroupName="bfpotong" Text="Angsuran 1"></asp:RadioButton>
                                &nbsp;&nbsp;
									<asp:RadioButton class="radio" ID="dpspotong" runat="server" GroupName="bfpotong" Text="DP disebar"></asp:RadioButton>
                                &nbsp;&nbsp;
									<asp:RadioButton class="radio" ID="angspotong" runat="server" GroupName="bfpotong" Text="Angsuran disebar"></asp:RadioButton>
                                &nbsp;&nbsp;
									<asp:RadioButton class="radio" ID="tidakpotong" runat="server" GroupName="bfpotong" Text="BF tidak disebar"></asp:RadioButton>

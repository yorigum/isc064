...
<html lang="en">
<head>
    <title>Batavianet Business Application :: Administrasi Jual</title>
...
<body style="overflow: hidden;">
        ...
        <div id="labels">
            ...
            <div class="user-thumb" onclick="usermenu()">
                ...
                <div class="user-menu" id="usermenu">
                    ...
                    <p onclick="if (confirm('Apakah Anda ingin melakukan sign-out?\nProgram dan absensi aktif Anda akan ditutup.')) {
                                        location.href = '/SignOut.aspx'
                                    }">
                        <i class="fa fa-power-off user-icon" aria-hidden="true"></i>&nbsp;Log Out
                    </p>
                </div>
            </div>
    ...
    <div class="main-footer clear">
        <div class="copyright">
            <asp:Label runat="server" ID="thn"></asp:Label> &copy; Batavianet. All Rights Reserved.
        </div>
        <div class="contact">

...
<%@ Page Language="c#" Inherits="ISC064.ADMINJUAL.TipeSalesDaftar" CodeFile="TipeSalesDaftar.aspx.cs" %>

<!DOCTYPE html>
<html lang="en">
<head>
    <title>Pendaftaran Tipe Sales Baru</title>
    ...
    <meta name="sec" content="Jenis Unit - Pendaftaran Tipe Sales Baru">
</head>
<body class="body-padding">
    <form class="cnt" id="Form1" method="post" runat="server">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <h1 class="title title-line">Pendaftaran Tipe Sales Baru</h1>
        <br />
        <table cellspacing="0">
            <tr valign="top">
                <td style="padding-right: 10px">
                    ...
                    <asp:ListBox ID="baru" Enabled="false" Rows="25" runat="server" Width="200" CssClass="ddl"></asp:ListBox>
                    <p class="feed">
                ...
                <td>
                    <asp:Label ID="noreftipe" runat="server" ForeColor="Red" Font-Bold="True"></asp:Label>
                    <table cellspacing="5">
                        <tr>
                            <td colspan="3">
                                <p>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="tipe" runat="server" CssClass="txt" Width="150" MaxLength="20"></asp:TextBox>

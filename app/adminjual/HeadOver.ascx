<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HeadOver.ascx.cs" Inherits="ISC064.ADMINJUAL.HeadOver" %>
...
<table cellspacing="5">
	<tr>
		...
		<td style="font-size:8pt;padding-left:10">
			No. SN :
			<asp:label id="noSN" runat="server" font-bold="True"></asp:label>
		</td>
		<td style="font-size:8pt;padding-left:10">
			Jabatan :
			<asp:label id="jabatan" runat="server" font-bold="True"></asp:label>
		</td>
	</tr>
</table>

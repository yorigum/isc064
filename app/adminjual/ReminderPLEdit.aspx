<%@ Page Language="c#" Inherits="ISC064.ADMINJUAL.ReminderPLEdit" CodeFile="ReminderPLEdit.aspx.cs" %>

<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>Reminder Price List Edit Unit</title>
    ...
    <meta name="sec" content="Reminder - Price List Edit Unit">
</head>
<body class="body-padding" onkeyup="if(event.keyCode==27)document.getElementById('cancel').click()">
    <form id="Form1" method="post" runat="server" class="cnt">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <h1 class="title title-line">Reminder Price List Edit Unit</h1>
        <p class="feed">

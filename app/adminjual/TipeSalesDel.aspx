...
<%@ Page Language="c#" Inherits="ISC064.ADMINJUAL.TipeSalesDel" CodeFile="TipeSalesDel.aspx.cs" %>

<!DOCTYPE html>
<html lang="en">
<head>
    <title>Delete Tipe Sales</title>
    ...
    <meta name="sec" content="Tipe Sales - Delete Tipe Sales">
</head>
<body class="body-padding" onkeyup="if(event.keyCode==27) history.back(-1)">
    <form id="Form1" method="post" runat="server">
        <div id="frm" runat="server">
            <input type="text" style="display: none">
            <h1 class="title title-line">Delete Tipe Sales</h1>
            <br>
            Keterangan :
        ...
        <asp:Label ID="nodel" runat="server" Visible="false">
				<h1>
					Tipe Sales Tidak Dapat Dihapus
				</h1>
				<br>
				<div class="plike">
					...
					<ul>						
						<li>
							Tipe Sales tersebut sudah memiliki Sales.
						</li>
					</ul>
				</div>
        </asp:Label>

...
namespace ISC064.ADMINJUAL
{
    ...
    public partial class AgentTipeDaftar : System.Web.UI.Page
    {
        ...
        protected void save_Click(object sender, EventArgs e)
        {
            if (valid())
            {
                Db.Execute("exec spAgentLevelDaftar '" + namaTipe.Text + "','" + tipe.SelectedValue + "'");

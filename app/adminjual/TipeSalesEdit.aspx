<%@ Page Language="c#" Inherits="ISC064.ADMINJUAL.TipeSalesEdit" CodeFile="TipeSalesEdit.aspx.cs" %>

<%@ Register TagPrefix="uc1" TagName="HeadAgent" Src="HeadTipeAgent.ascx" %>
<%@ Register TagPrefix="uc1" TagName="NavAgent" Src="NavTipeAgent.ascx" %>
<!DOCTYPE html>
<html lang="en">
<head>
                        ...
                        <td width="400">
                            <table cellspacing="5">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="notipe" runat="server" CssClass="txt" Width="150" ReadOnly="True"></asp:TextBox>
                                        <asp:Label ID="notipec" runat="server" CssClass="err"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Project</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="tipe" runat="server" Width="75" CssClass="txt" MaxLength="20"></asp:TextBox>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TipeGimmickDel.aspx.cs" Inherits="ISC064.ADMINJUAL.TipeGimmickDel" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Delete Tipe Gimmick</title>
    ...
    <meta name="sec" content="Delete Tipe Gimmick">
</head>
<body class="body-padding" onkeyup="if(event.keyCode==27) history.back(-1)">
    <form id="Form1" method="post" runat="server">
        <div id="frm" runat="server">
            <input type="text" style="display: none">
            <h1 class="title title-line">Delete Tipe Gimmick</h1>
            <br>
            Keterangan :

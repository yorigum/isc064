...
<%@ Page Language="c#" Inherits="ISC064.ADMINJUAL.LokasiDaftar" CodeFile="LokasiDaftar.aspx.cs" %>

<!DOCTYPE html>
<html lang="en">
<head>
    <title>Pendaftaran Lokasi Unit Baru</title>
    ...
    <meta name="sec" content="Lokasi Unit - Pendaftaran Lokasi Unit Baru">
</head>
<body class="body-padding">
    <form class="cnt" id="Form1" method="post" runat="server">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <h1 class="title title-line">Pendaftaran Lokasi Unit Baru</h1>
        <br />
        <table cellspacing="0">
            <tr valign="top">

<%@ Page language="c#" Inherits="ISC064.SECURITY.CounterLaunchingDel" CodeFile="CounterLaunchingDel.aspx.cs" %>
<!doctype html>
<html>
	<head>
		<title>Delete Counter Launching</title>
		...
		<meta name="sec" content="Security - Delete Counter Launching">
	</head>
	<body class="body-padding" onkeyup="if(event.keyCode==27) history.back(-1)">
		<form id="Form1" method="post" runat="server">
			<div id="frm" runat="server">
				<input type="text" style="display:none">
				<h1 class="title title-line">Delete Counter Launching</h1>
				<br>
				Keterangan :

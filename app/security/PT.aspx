...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PT.aspx.cs" Inherits="ISC064.SECURITY.PT" %>
<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head>
		<title>Matrikulasi Akses Perusahaan</title>
		...
		<meta name="sec" content="Matrikulasi Akses Perusahaan">
	</head>
	<body class="body-padding">
		<form id="Form1" method="post" runat="server" class="cnt">
			<uc1:head id="Head1" runat="server"></uc1:head>
			<h1 class="title title-line">Matrikulasi Akses Perusahaan</h1>
			<p class="feed">

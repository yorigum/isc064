<%@ Page Language="c#" Inherits="ISC064.SECURITY.Aktivasi" CodeFile="Aktivasi.aspx.cs" %>
            ...
            <table style="border: 1px solid #DCDCDC" cellspacing="5">
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" value="..." class="btn btn-orange" onclick="popDaftarBlokir();" id="btnpop" runat="server"
                            name="btnpop">

<%@ Page language="c#" Inherits="ISC064.SECURITY.Mapping" CodeFile="Mapping.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html lang="en">
	<head>
		<title>Mapping Program</title>
		...
		<meta name="sec" content="Setup Mapping Program">
	</head>
	<body class="body-padding">
		<form id="Form1" method="post" runat="server" class="cnt">
			<uc1:head id="Head1" runat="server"></uc1:head>
			<h1 class="title title-line">Mapping Program</h1>
			<br>
			<table style="border:1px solid #DCDCDC" cellspacing="5">
				<tr>
					<td>
						<input type="button" onclick="if(confirm('Lanjutkan proses map ulang?')){location.href='MappingUlang.aspx'}"

<%@ Page language="c#" Inherits="ISC064.SECURITY.ReminderIdle" CodeFile="ReminderIdle.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>Reminder Username Idle</title>
    ...
    <form id="Form1" method="post" runat="server" class="cnt">
        ...
        <asp:GridView ID="tb" runat="server" SkinID="pager" OnPageIndexChanging="tb_PageIndexChanging">
            <Columns>
                ...
                <asp:BoundField HeaderText="Terakhir Login" DataField="Login" />
            </Columns>
        </asp:GridView>

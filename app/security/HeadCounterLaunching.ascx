<%@ Control Language="c#" Inherits="ISC064.SECURITY.HeadCounterLaunching" CodeFile="HeadCounterLaunching.ascx.cs" %>
...
<table cellspacing="5">
	<tr>
		...
		<td style="font-size:8pt;padding-left:10px">
			<b>User :</b>
			<asp:label id="user" runat="server" font-bold="True"></asp:label>
		</td>
	</tr>
</table>

...
namespace ISC064.MARKETINGJUAL
{
	public partial class PrintAJB : System.Web.UI.Page
	{
		...
		private void Fill()
		{
			...
			string strSql = "SELECT PrintAJB FROM MS_KONTRAK WHERE NoKontrak = '" + NoKontrak + "' AND AJB = 'D'";
			...
			else
			{
                ...
                { 
                    ...
                    ConvertPdf();
                    Response.Redirect(Param.PathLinkFilePDFMarketingJual + NoKontrak.Replace("/", "_") + "_AJB.pdf");
                }
                else
				{
					//mekanisme reprint
		...
		private void Tampil()
		{
			...
			//increment
			Db.Execute("UPDATE MS_KONTRAK SET PrintAJB = PrintAJB + 1 WHERE NoKontrak = '" + NoKontrak + "'");
        ...
        private void ConvertPdf()
        {
            ...
            string myHtml = "http://localhost:8034/marketingjual/PrintAJB1.aspx?NoKontrak=" + NoKontrak;

            string save = Param.PathFilePDFMarketingJual + NoKontrak.Replace("/","_") + "_AJB.pdf";
		...
		private void Valid(string Username)
		{
            ...
            Tampil();
            string file = Param.PathFilePDFMarketingJual + NoKontrak.Replace("/", "_") + "_AJB.pdf";

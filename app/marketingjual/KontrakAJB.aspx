...
<%@ Page language="c#" Inherits="ISC064.MARKETINGJUAL.KontrakAJB" CodeFile="KontrakAJB.aspx.cs" %>
<!DOCTYPE html>
<html>
	<head>
				...
				<table style="BORDER-RIGHT:#dcdcdc 1px solid; BORDER-TOP:#dcdcdc 1px solid; BORDER-LEFT:#dcdcdc 1px solid; BORDER-BOTTOM:#dcdcdc 1px solid"
					...
					<tr>
						...
						<td>
							...
							<input type="button" value="&#xf002;" style="font-family: 'fontawesome'" class="btn btn-orange" show-modal='#ModalPopUp' modal-title='Daftar Kontrak' modal-url='DaftarKontrak.aspx?status=a&ajb=1'
			...
			<div id="frm" runat="server">
				...
				<table cellspacing="5">
					...
					<tr>
						...
						<td>
							<nobr>
								<asp:textbox id="tglajb" runat="server" cssclass="txt_center" width="85"></asp:textbox>

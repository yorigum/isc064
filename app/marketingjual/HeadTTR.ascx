<%@ Control Language="c#" Inherits="ISC064.MARKETINGJUAL.HeadTTR" CodeFile="HeadTTR.ascx.cs" %>
...
<table cellspacing="5">
	<tr>
		...
		<td style="font-size:8pt;padding-left:10px">
			No. TTR :
			<asp:label id="nottr" runat="server" font-bold="True"></asp:label>
		</td>
		<td style="font-size:8pt;padding-left:10px">
			No. Reservasi :
			<asp:label id="noreservasi" runat="server" font-bold="True"></asp:label>
		</td>
		<td style="font-size:8pt;padding-left:10px">
			Unit :

<%@ Reference Control="~/PrintGimmickTemplate.ascx" %>
<%@ Reference Control="~/PrintGimmickTemplate2.ascx" %>

<%@ Page Language="c#" Inherits="ISC064.MARKETINGJUAL.PrintGimmick" CodeFile="PrintGimmick.aspx.cs" %>

<!DOCTYPE html>
<html>
<head>
    <title>Print Tanda Terima Gimmick</title>
    ...
    <meta name="sec" content="Print Tanda Terima Gimmick">
    <style type="text/css">
        #print TD {
            FONT: 6.5pt arial;
        }

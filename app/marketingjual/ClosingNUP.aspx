<%@ Page Language="c#" Inherits="ISC064.MARKETINGJUAL.ClosingNUP" CodeFile="ClosingNUP.aspx.cs" %>

<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html>
<head>
    <title>Closing Kontrak NUP</title>
    ...
    <meta name="sec" content="Closing Kontrak NUP">
</head>
<body class="body-padding">
    <form id="Form1" method="post" runat="server" class="cnt">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <h1 class="title title-line">Closing Kontrak NUP</h1>
        <table style="border: 1px solid #DCDCDC" cellspacing="5">
            <tr>
                <td></td>
                <td>
                    <asp:DropDownList ID="status" runat="server" Width="200" Visible="false">

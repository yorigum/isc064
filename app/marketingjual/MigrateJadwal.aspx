<%@ Page language="c#" Inherits="ISC064.MARKETINGJUAL.MigrateJadwal" CodeFile="MigrateJadwal.aspx.cs" %>
...
<html>
	<head>
		...
		<meta name="sec" content="Migrate - Approval Jadwal Tagihan (Hal. 1)">
	</head>
	<body>
		<form id="Form1" method="post" runat="server" class="cnt">
			...
			<script language="javascript">
			    function hapus(nokontrak) {
			        if (confirm('Apakah anda ingin menghapus tagihan : ' + nokontrak + '?\nPerhatian bahwa data akan dihapus secara PERMANEN.')) {
			            location.href = 'MigrateJadwalDel.aspx?NoKontrak=' + nokontrak;
			        }
			    }
			</script>
		</form>

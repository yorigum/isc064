<%@ Page language="c#" Inherits="ISC064.MARKETINGJUAL.Laporan.LaporanCancel" CodeFile="LaporanCancel.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="Head" Src="../Head.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head>
		<title>Laporan Cancel</title>
		...
		<meta name="sec" content="Laporan Cancel">
	</head>
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:table id="rpt" runat="server" cssclass="tb" cellspacing="3">
				...
				<asp:tablerow verticalalign="Bottom">
					...
					<asp:tableheadercell horizontalalign="Left">Tgl. Surat Pesanan</asp:tableheadercell>
					...
					<asp:tableheadercell horizontalalign="Right">Uang Masuk</asp:tableheadercell>
					<asp:tableheadercell horizontalalign="Right">Biaya ADM</asp:tableheadercell>
					<asp:tableheadercell horizontalalign="Right">Uang Keluar</asp:tableheadercell>

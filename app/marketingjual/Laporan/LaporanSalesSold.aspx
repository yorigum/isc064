<%@ Page language="c#" Inherits="ISC064.MARKETINGJUAL.Laporan.LaporanSalesSold" CodeFile="LaporanSalesSold.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="Head" Src="../Head.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head>
		<title>Laporan Unit Terjual</title>
		...
		<meta name="sec" content="Laporan Unit Terjual">
	</head>
		...
		<form id="Form1" method="post" runat="server">
								...
								<td>
									...
									<p class="pparam">
										...
										<asp:radiobuttonlist id="sort" runat="server">
											<asp:listitem value="TglInput" selected="True">Tgl. Input</asp:listitem>
			...
			<asp:table id="rpt" runat="server" cssclass="tb" cellspacing="3">
				...
				<asp:tablerow verticalalign="Bottom">
					...
					<asp:tableheadercell horizontalalign="Left">Tgl Pembayaran</asp:tableheadercell>
					<asp:tableheadercell horizontalalign="Right">BF</asp:tableheadercell>
					<asp:tableheadercell horizontalalign="Right">DP</asp:tableheadercell>
					<asp:tableheadercell horizontalalign="Right">Angsuran</asp:tableheadercell>
				</asp:tablerow>
			</asp:table>
		</form>
	</body>

...
namespace ISC064.MARKETINGJUAL.Laporan
{
    public partial class MasterKomisi : System.Web.UI.Page
    {
        ...
        protected void pdf_Click(object sender, System.EventArgs e)
        {
            ...
            string link = Mi.PathAlamatWeb + "marketingjual/LaporanPDF/PDFMasterKomisi.aspx?id=" + rs.Rows[0]["AttachmentID"]
                + "&status_s=" + nStatusS
                + "&status_b=" + nStatusB
                + "&status_a=" + nStatusA
                + "&sales=" + Sales
            ...
            //format page
            p.StartInfo.Arguments = "--orientation landscape --page-width 45cm --page-height 100cm --margin-left 0 --margin-right 0 --margin-top 0.25cm --margin-bottom 0 " + link + " " + save;

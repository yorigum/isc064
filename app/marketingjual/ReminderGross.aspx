<%@ Reference Page="~/KontrakDiskon.aspx" %>
<%@ Page language="c#" Inherits="ISC064.MARKETINGJUAL.ReminderGross" CodeFile="ReminderGross.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html>
<head>
    <title>Reminder Mutasi Price List</title>
    ...
    <form id="Form1" method="post" runat="server" class="cnt">
        ...
        <asp:GridView ID="tb" runat="server" SkinID="pager" OnPageIndexChanging="tb_PageIndexChanging">
            <Columns>
                ...
                <asp:BoundField HeaderText="Sebelum Diskon" DataField="BlmDiskon" />
                <asp:BoundField HeaderText="Diskon" DataField="Diskon" />

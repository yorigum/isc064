<%@ Reference Control="~/PrintKwitansiGabungTemplate.ascx" %>
<%@ Page language="c#" Inherits="ISC064.MARKETINGJUAL.PrintKwitansiGabung" CodeFile="PrintKwitansiGabung.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head>
		<title>Print Kwitansi Gabungan</title>
		...
		<meta name="sec" content="Print Kwitansi Gabungan">
		<style type="text/css">
		#p td
		{
			font-size: 10pt;
	...
	<body onkeyup="if(event.keyCode==27&&document.getElementById('cancel')){document.getElementById('cancel').click()}else if(event.keyCode==27){document.getElementById('cancel2').click()}">
		...
		<form id="Form1" method="post" runat="server">
			<div id="reprint" runat="server">
				...
				<p style="padding:5">
					Jenis Dokumen : <u style="font:bold 10pt">Kwitansi Resmi</u>
					<br>
			...
			<div style="display:none"><input type="button" id="cancel2" runat="server"></div>
			<div id="p">

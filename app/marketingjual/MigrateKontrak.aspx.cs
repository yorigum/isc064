...
{
    public partial class MigrateKontrak : System.Web.UI.Page
    {
        ...
        private void Fill()
        {
            ...
            for (int i = 0; i < rs.Rows.Count; i++)
            {
                ...
                c = new TableCell();
                c.Text = "<a href='MigrateKontrak2.aspx?NoKontrak=" + rs.Rows[i]["NoKontrak"] + "'>Next...</a>";
                r.Cells.Add(c);
                ...
                c = new TableCell();
                c.Text = Cf.Day(Convert.ToDateTime(rs.Rows[i]["TglKontrak"]));
                r.Cells.Add(c);

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KomisiBayarCF.aspx.cs" Inherits="ISC064.MARKETINGJUAL.KomisiBayarCF" %>
...
<head runat="server">
    ...
    <meta name="sec" content="Kontrak - Bayar Closing Fee">
    ...
    <div class="pad">
        ...
        <table cellpadding="5">
            <tr>
                ...
                <td>
                    <asp:Label ID="notacf1" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
                    Tgl. Bayar Closing Fee
                </td>
                <td>
                    :
                </td>
                <td>
                    <asp:TextBox ID="tbTglBayarClosing" runat="server" CssClass="txt_center" Width="85"></asp:TextBox>
                    <label for="tbTglBayarClosing" class="btn btn-cal"><i class="fa fa-calendar"></i></label>

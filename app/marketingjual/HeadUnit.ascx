<%@ Control Language="c#" Inherits="ISC064.MARKETINGJUAL.HeadUnit" CodeFile="HeadUnit.ascx.cs" %>
...
<table cellspacing="5">
	<tr>
		<td>
            <a id="prev" runat="server" accesskey="," class="abtn"><i class="fa fa-long-arrow-left"></i> <b>Prev</b></a>
		</td>
		<td>
            <a id="next" runat="server" accesskey="." class="abtn"><b>Next</b> <i class="fa fa-long-arrow-right"></i></a>
		</td>
		<td style="font-size:8pt;padding-left:10px">
			No. Stock :
			<asp:label id="nostock" runat="server" font-bold="True"></asp:label>
		</td>
		<td style="font-size:8pt;padding-left:10px">
			Unit :

<%@ Page language="c#" Inherits="ISC064.MARKETINGJUAL.ReminderBF" CodeFile="ReminderBF.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html>
<head>
    <title>Reminder Kontrak yang Baru Bayar Sampai BF</title>
    ...
    <meta name="sec" content="Reminder - Kontrak yang Baru Bayar Sampai BF">
</head>
<body class="body-padding" onkeyup="if(event.keyCode==27)document.getElementById('cancel').click()">
    <form id="Form1" method="post" runat="server" class="cnt">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <h1 class="title title-line">Reminder Kontrak yang Baru Bayar Sampai BF</h1>
        <p class="feed">
        ...
        <table height="50">
            <tr>
                <td>
                    <a href="" runat="server" id="ok" type="button" class="btn btn-blue t-white" value="OK"

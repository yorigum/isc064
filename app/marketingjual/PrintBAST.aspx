<%@ Reference Control="~/PrintBASTTemplate.ascx" %>
<%@ Page language="c#" Inherits="ISC064.MARKETINGJUAL.PrintBAST" CodeFile="PrintBAST.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head>
		<title>Print Berita Acara Serah Terima</title>
		...
		<meta name="sec" content="Print Berita Acara Serah Terima">
	</head>
	<body onkeyup="if(event.keyCode==27&&document.getElementById('cancel')){document.getElementById('cancel').click()}else if(event.keyCode==27){document.getElementById('cancel2').click()}">
		...
		<form id="Form1" method="post" runat="server">
			<div id="reprint" runat="server">
				...
				<p style="padding:5">
					Jenis Dokumen : <u style="font:bold 10pt">Berita Acara Serah Terima</u>
					<br>

...
<%@ Page language="c#" Inherits="ISC064.MARKETINGJUAL.KwitansiGabung" CodeFile="KwitansiGabung.aspx.cs" %>
	...
	<body class="body-padding" onkeyup="&#13;&#10;&#9;if(document.getElementById('backbtn')){if(event.keyCode==27)document.getElementById('backbtn').click()};&#13;&#10;&#9;if(document.getElementById('cancel')){if(event.keyCode==27)document.getElementById('cancel').click()}">
		<form id="Form1" method="post" runat="server" class="cnt">
			...
			<div id="pilih" runat="server">
				<h1 class="title title-line">Kwitansi Gabungan</h1>
				...
				<table style="BORDER-RIGHT:#dcdcdc 1px solid; BORDER-TOP:#dcdcdc 1px solid; BORDER-LEFT:#dcdcdc 1px solid; BORDER-BOTTOM:#dcdcdc 1px solid"
					...
					<tr>
						...
						<td>
							...
							<input type="button" value="&#xf002;" style="font-family: 'fontawesome'" class="btn btn-orange" onclick="popDaftarKontrak('a&amp;KwitansiGabung=1')"
			...
			<div id="frm" runat="server">
				...
				<table cellspacing="5">
					<tr>
						<td>No. Kwitansi Gabungan</td>
						<td>:</td>
						<td>
							<asp:textbox id="nokwitansigabung" runat="server" cssclass="txt" width="120" maxlength="20" readonly="True">#AUTO#</asp:textbox>
							<asp:label id="nokwitansigabungc" runat="server" cssclass="err"></asp:label>
						</td>
					</tr>
				</table>
				<table height="50px">
					<tr>
						<td>
							<asp:button id="save" runat="server" cssclass="btn btn-blue" text="OK" width="75" Enabled="False" onclick="save_Click"></asp:button>
						</td>
						<td>

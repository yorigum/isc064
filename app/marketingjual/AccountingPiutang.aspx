<%@ Page language="c#" Inherits="ISC064.MARKETINGJUAL.AccountingPiutang" CodeFile="AccountingPiutang.aspx.cs" %>
	...
	<body>
		<form class="cnt" id="Form1" method="post" runat="server">
			...
			<div id="isi" runat="server">
				...
				<br>
				<asp:button id="ok" runat="server" width="75" text="Generate" cssclass="btn" onclick="ok_Click"></asp:button>
				<br>
				<br>

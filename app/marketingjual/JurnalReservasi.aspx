<%@ Page language="c#" Inherits="ISC064.MARKETINGJUAL.JurnalReservasi" CodeFile="JurnalReservasi.aspx.cs" %>
...
<html>
	<head>
		...
		<meta name="sec" content="Jurnal Reservasi">
	</head>
	<body onkeyup="if(event.keyCode==27)document.getElementById('cancel').click()">
		<form id="Form1" method="post" runat="server">
			<div class="content-header">
				<uc1:navreservasi id="NavReservasi1" runat="server" aktif="3"></uc1:navreservasi>
			</div>
			<div class="tabdata">
				<div class="pad">

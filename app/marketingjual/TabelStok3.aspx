<%@ Page language="c#" Inherits="ISC064.MARKETINGJUAL.TabelStok3" CodeFile="TabelStok3.aspx.cs" %>
...
<html>
	<head>
		...
		<meta name="sec" content="Unit - Reservasi Launching (Hal. 2)">
	</head>
	<body>
		<form id="Form1" method="post" runat="server" class="cnt">
			<uc1:head id="Head1" runat="server"></uc1:head>
			<h1 class="title title-line">Reservasi Launching</h1>
			<p><b><i>Halaman 2 dari 2</i></b></p>
			<br>
			<h2 style="color:brown;border:1 solid silver;padding:10">
				Reservasi Launching Selesai
			</h2>
			<br>
			<table cellspacing="5">
				<tr>

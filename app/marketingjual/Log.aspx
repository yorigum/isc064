            ...
            <tr>
                ...
                <td colspan="8">
                    <asp:RadioButtonList ID="tb" runat="server" RepeatDirection="Horizontal"
                        ...
                        <asp:ListItem class="radio" Value="MS_CUSTOMER_LOG">CUSTOMER</asp:ListItem>
                        <asp:ListItem class="radio" Value="MS_RESERVASI_LOG">RESERVASI</asp:ListItem>
                        <asp:ListItem class="radio" Value="MS_KONTRAK_LOG">KONTRAK</asp:ListItem>
                        <asp:ListItem class="radio" Value="MS_TTR_LOG">TTR</asp:ListItem>
                    </asp:RadioButtonList>
                    <asp:DropDownList ID="href" runat="server" Visible="False">
                        <asp:ListItem Value="MS_CUSTOMER_LOG">CustomerEdit.aspx?NoCustomer='%pk%'</asp:ListItem>
                        <asp:ListItem Value="MS_RESERVASI_LOG">ReservasiEdit.aspx?NoReservasi='%pk%'</asp:ListItem>
                        <asp:ListItem Value="MS_KONTRAK_LOG">KontrakEdit.aspx?NoKontrak='%pk%'</asp:ListItem>
                        <asp:ListItem Value="MS_TTR_LOG">TTREdit.aspx?NoTTR='%pk%'</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>

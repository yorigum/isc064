	...
	<body class="body-padding pop" onkeyup="if(event.keyCode==27)window.close()"
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:dropdownlist id="akt3" runat="server" visible="False">
                ...
                <asp:listitem value="APR-GN">APR-GN = Approval Pengalihan Hak</asp:listitem>
                <asp:listitem value="APR-GU">APR-GU = Approval Pindah Unit</asp:listitem>
                <asp:listitem value="APR-BA">APR-GN = Approval Batal Kontrak</asp:listitem>
                <asp:listitem value="APR-CU">APR-CU = Approval Custom Tagihan</asp:listitem>
                <asp:listitem value="APR-RE">APR-RE = Approval Reschedule Tagihan</asp:listitem>
                <asp:listitem value="APR-ADJ">APR-ADJ = Approval Adjustment Tagihan</asp:listitem>
                <asp:listitem value="APR-DI">APR-ADJ = Approval Diskon</asp:listitem>
                ...
                <asp:listitem value="D-GIM">D-GIM = Daftar Kontrak Gimmick</asp:listitem>
                <asp:listitem value="E-GIM">E-GIM = Edit Kontrak Gimmick</asp:listitem>
			</asp:dropdownlist>

...
<%@ Page Language="c#" Inherits="ISC064.MARKETINGJUAL.Laporan.MasterKomisi" CodeFile="PDFMasterKomisiNonSales.aspx.cs" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <asp:Table ID="rpt" runat="server" CssClass="tb blue-skin" CellSpacing="1">
            <asp:TableRow VerticalAlign="middle">
                ...
                <asp:TableHeaderCell HorizontalAlign="Right">Komisi Overriding Cadangan</asp:TableHeaderCell>
                <asp:TableHeaderCell HorizontalAlign="Right">Komisi Overriding Kinerja</asp:TableHeaderCell>
                <asp:TableHeaderCell HorizontalAlign="Right">Komisi Overriding Kantor Pusat</asp:TableHeaderCell>
            </asp:TableRow>
        </asp:Table>
    </form>
</body>

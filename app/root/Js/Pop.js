...
function openPopUp(myFile, myWidth, myHeight) {
    if (myWidth == "") myWidth = 750;
    if (myHeight == "") myHeight = 550;
    myWindowName = "_blank";
    LeftPosition = (screen.width) ? (screen.width - myWidth) / 2 : 100;
    TopPosition = 10;
...
function openModal(myFile, myWidth, myHeight) {
    ...
    lockWindow = PopupCenter(myFile, "", myWidth, myHeight);
    //window.showModalDialog(myFile, window, "help:no;status:no;dialogHeight:" + myHeight + "px;dialogWidth:" + myWidth + "px")
}

...
namespace ISC064.LEGAL
{
	public partial class PrintBAST : System.Web.UI.Page
	{
		...
		private void Fill()
		{
			...
			string strSql = "SELECT PrintBAST FROM MS_BAST WHERE NoKontrak = '" + NoKontrak + "' AND ST != 'B'";
			...
			else
			{
                ...
                if ((int)rs.Rows[0]["PrintBAST"] == 0)
                {
                    ...
                    ConvertPdf();
                    Response.Redirect(Param.PathLinkFilePDFLegal + NoKontrak.Replace("/", "_") + "_BAST.pdf");
                }
				else
				{
					//mekanisme reprint
		...
		private void Tampil()
		{
			...
			//increment
			Db.Execute("UPDATE MS_BAST SET PrintBAST = PrintBAST + 1 WHERE NoKontrak = '" + NoKontrak + "'");
        ...
        private void ConvertPdf()
        {
            ...
            string myHtml = "http://localhost:8034/legal/PrintBAST1.aspx?NoKontrak=" + NoKontrak;

            string save = Param.PathFilePDFLegal + NoKontrak.Replace("/", "_") + "_BAST.pdf";
        ...
        private void Valid(string Username)
		{
            ...
            Tampil();
            string file = Param.PathFilePDFLegal + NoKontrak.Replace("/", "_") + "_BAST.pdf";

...
namespace ISC064.LEGAL
{
	public partial class KontrakDiskon : System.Web.UI.Page
	{
		...
		private bool datavalid()
		{
			...
			decimal Netto;
            Netto = Convert.ToDecimal(gross.Text) + Convert.ToDecimal(gimmick.Text) + Convert.ToDecimal(lainlain.Text) - Convert.ToDecimal(disc.Text) + Convert.ToDecimal(bunga.Text);
		...
		protected void save_Click(object sender, System.EventArgs e)
		{
			...
			//	decimal PPN = Convert.ToDecimal(ppn.Text);
                ...
                decimal NilaiDPP = Math.Round(Convert.ToDecimal(Convert.ToDouble(NilaiKontrak) / 1.1));
                decimal NilaiPPN = Math.Round((Decimal)0.1 * NilaiDPP);

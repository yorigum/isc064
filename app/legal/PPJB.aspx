<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PPJB.aspx.cs" Inherits="PPJB" %>--%>

<%@ Page language="c#" Inherits="ISC064.LEGAL.PPJB" CodeFile="PPJB.aspx.cs" %>
...
<html>
	<head>
		...
		<meta name="sec" content="PPJB">
	</head>
	<body class="body-padding">
		<form id="Form1" method="post" runat="server" class="cnt">
			<uc1:head id="Head1" runat="server"></uc1:head>
			<input type="text" style="display:none">
			<h1 class="title title-line">PPJB</h1>
			<br>

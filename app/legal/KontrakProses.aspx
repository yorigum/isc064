        ...
        <div class="tabdata">
            <div class="pad">
                ...
                <div style="float: left; width: 350px">
                    ...
                    <table cellspacing="5">
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <asp:DropDownList ID="bank" runat="server" Width="250" CssClass="ddl">
                        ...
                        <tr>
                            <td colspan="3">
                                <asp:Button ID="ok" runat="server" CssClass="btn btn-blue" Text="Edit Bank KPR" OnClick="ok_Click" Style="margin-right:10px;"></asp:Button><input class="btn" id="berkas" type="button" value="Checklist Berkas"
                                    name="berkas" runat="server" onserverclick="berkas_ServerClick">
                            </td>
                        </tr>
                        <tr style="display: none">
                            <td colspan="3">
                                <input class="btn btn-blue" id="fiksi" style="width: 100px" type="button" value="Kontrak UP" name="fiksi"
                                    runat="server">
                            </td>
                        </tr>
                    </table>
                ...
                <div style="float: left">
                    ...
                    <input class="btn btn-blue" id="btnEditWawancara" style="width: 150px" type="button" value="Edit Wawancara"
                        name="btnEditWawancara" runat="server">
                    ...
                    <input class="btn btn-blue" id="editots" style="width: 150px" type="button" value="Edit OTS" name="editots"
                        runat="server">
                    <hr color="silver" noshade size="1">
                    ...
                    <input class="btn btn-blue" id="btnEditLPA" style="width: 150px" type="button" value="Edit LPA"
                        name="btnEditLPA" runat="server">
                    <hr color="silver" noshade size="1">
                    ...
                    <input class="btn btn-blue" id="btnEditSP3K" style="width: 150px" type="button" value="Edit SP3K"
                        name="btnEditSP3K" runat="server">
                    <hr color="silver" noshade size="1">
                    ...
                    <input class="btn btn-blue" id="btnEditAkad" style="width: 150px" type="button" value="Edit Akad"
                        name="btnEditAkad" runat="server">
                    <hr color="silver" noshade size="1">
                    ...
                    <%--<input class="btn" id="btnEditAJB" style="WIDTH: 150px" type="button" value="Edit AJB"
							name="btnEditAJB" runat="server" >--%>
                    ...
                    <input class="btn btn-blue" id="btnEditSertifikat" style="width: 150px" type="button" value="Edit Sertifikat"
                        name="btnEditSertifikat" runat="server">
                    <hr color="silver" noshade size="1">
                    ...
                    <input class="btn btn-blue" id="btnEditImb" style="width: 150px" type="button" value="Edit IMB"
                        name="btnEditImb" runat="server">
                <br />
                <br />
                <br />
                </div>

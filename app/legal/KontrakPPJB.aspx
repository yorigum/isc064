<%@ Page language="c#" Inherits="ISC064.LEGAL.KontrakPPJB" CodeFile="KontrakPPJB.aspx.cs" %>
	...
	<body class="body-padding" onkeyup="&#13;&#10;&#9;if(document.getElementById('backbtn')){if(event.keyCode==27)document.getElementById('backbtn').click()};&#13;&#10;&#9;if(document.getElementById('cancel')){if(event.keyCode==27)document.getElementById('cancel').click()}">
		<form id="Form1" method="post" runat="server" class="cnt">
			...
			<div id="frm" runat="server">
				...
				<table cellspacing="5">
					<tr>
						<td style="width:100px">No. PPJB</td>
						<td>:</td>
						<td>
							<asp:textbox id="noppjb" runat="server" cssclass="txt" width="100" maxlength="20" readonly="True" style="text-align:center">#AUTO#</asp:textbox>
					...
					<tr>
						...
						<td>
							<nobr>
								<asp:textbox id="tglppjb" runat="server" cssclass="txt_center tgl" width="85"></asp:textbox>

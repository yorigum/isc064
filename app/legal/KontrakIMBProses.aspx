<%@ Page language="c#" Inherits="ISC064.LEGAL.KontrakIMBProses" CodeFile="KontrakIMBProses.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html>
	<head>
		<title>Proses IMB</title>
		...
		<meta name="sec" content="Kontrak - Proses IMB">
	</head>
	<body class="body-padding" onkeyup="&#13;&#10;&#9;if(document.getElementById('backbtn')){if(event.keyCode==27)document.getElementById('backbtn').click()};&#13;&#10;&#9;if(document.getElementById('cancel')){if(event.keyCode==27)document.getElementById('cancel').click()}">
		<form id="Form1" method="post" runat="server" class="cnt">
			...
			<div id="pilih" runat="server">
				<h1 class="title title-line">Proses IMB</h1>
				...
				<table style="BORDER-RIGHT:#dcdcdc 1px solid; BORDER-TOP:#dcdcdc 1px solid; BORDER-LEFT:#dcdcdc 1px solid; BORDER-BOTTOM:#dcdcdc 1px solid"
					...
					<tr>
                        ...
                        <input class="btn btn-orange" id="btnpop" show-modal='#ModalPopUp' modal-title='Daftar Kontrak' modal-url='DaftarKontrak.aspx?status=a&st=1' type="button" value="&#xf002;" style="font-family: 'fontawesome'"
			...
			<table id="selesai" runat="server" cellspacing="5">
				<tr>
					...
					<td>:</td>
					<td>
						<asp:textbox id="tbTglProses" runat="server" cssclass="txt_center tgl" width="75" font-size="8"></asp:textbox>
						<label for="tbTglProses" class="btn btn-cal"><i class="fa fa-calendar"></i></label>
				...
				<tr>
					...
					<td>:</td>
					<td>
						<asp:textbox id="tbKeteranganIMB" runat="server" cssclass="txt" maxlength="1000" width="300" height="80"></asp:textbox>
					</td>
				</tr>
			</table>
				<table height="50">

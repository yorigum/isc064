<%@ Page language="c#" Inherits="ISC064.LEGAL.DaftarPPJB" CodeFile="DaftarPPJB.aspx.cs" %>
<!DOCTYPE html>
<html>
	<head>
		...
		<meta name="sec" content="(Pop-Up) Daftar PPJB">
			...
			<div class="pad">
				<table>
					<tr>
						...
						<td>
							<asp:dropdownlist id="metode" runat="server">

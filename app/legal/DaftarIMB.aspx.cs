...
public partial class DaftarIMB : System.Web.UI.Page
{
        ...
        private void Fill()
        {
            ...
            if (metode.SelectedIndex == 1)
                addq = "SELECT * FROM MS_IMB A INNER JOIN MS_KONTRAK B ON A.NoKontrak = B.NoKontrak "
                + "WHERE B.Status = 'A'";
            ...
            string strSql = "SELECT "
                ...
                + ",B.NoAJB"
                + ",B.NoPPJB"
                + " FROM MS_IMB A INNER JOIN MS_KONTRAK B ON A.NoKontrak = B.NoKontrak"

<%@ Page language="c#" Inherits="ISC064.LEGAL.KontrakStatus" CodeFile="KontrakStatus.aspx.cs" %>
<!DOCTYPE html>
<html>
	<head>
		...
		<form id="Form1" method="post" runat="server">
			...
			<table height="50">
				<tr>
					...
					<td>
						<input id="cancel" type="button" class="btn" value="Cancel" style="WIDTH:75px" onclick="window.close()">
					</td>

<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KontrakSertifikat.aspx.cs" Inherits="KontrakSertifikat" %>--%>
<%@ Page language="c#" Inherits="ISC064.LEGAL.KontrakSertifikat" CodeFile="KontrakSertifikat.aspx.cs" %>
...
<html>
	<head>
		...
		<meta name="sec" content="Kontrak - Sertifikat">
	</head>
	<body class="body-padding" onkeyup="&#13;&#10;&#9;if(document.getElementById('backbtn')){if(event.keyCode==27)document.getElementById('backbtn').click()};&#13;&#10;&#9;if(document.getElementById('cancel')){if(event.keyCode==27)document.getElementById('cancel').click()}">
		<form id="Form1" method="post" runat="server" class="cnt">
			...
			<div id="pilih" runat="server">
				<h1 class="title title-line">Registrasi Sertifikat</h1>
			...
			<table id="selesai" cellspacing="5" runat="server">
                <tr>
					...
					<td>:</td>
					<td><asp:textbox id="tbTgl" runat="server" cssclass="txt_center tgl" width="75" font-size="8"></asp:textbox><label for="tbTgl" class="btn btn-cal"><i class="fa fa-calendar"></i></label>
                ...
                <tr>
					...
					<td>:</td>
					<td><asp:radiobuttonlist id="statussertifikat" runat="server" repeatdirection="Horizontal">
				...
				<tr id="sertifikat1" runat="server">
					<td>Jangka Waktu</td>
					<td>:</td>
					<td><asp:textbox id="jangkawaktu" runat="server" cssclass="txt_num" width="50">0</asp:textbox> Tahun<asp:label id="jangkawaktuc" runat="server" cssclass="err"></asp:label></td>
				</tr>
                <tr id="sertifikat2" runat="server">
					<td>Tgl. Berakhir Sertifikat</td>
					<td>:</td>
					<td><asp:textbox id="tglakhir" runat="server" cssclass="txt_center tgl" width="75" font-size="8"></asp:textbox><label for="tglakhir" class="btn btn-cal"><i class="fa fa-calendar"></i></label>

<%@ Page language="c#" Inherits="ISC064.LEGAL.Sertifikat" CodeFile="Sertifikat.aspx.cs" %>
...
<html>
	<head>
		...
		<meta name="sec" content="Sertifikat">
	</head>
	<body class="body-padding">
		<form id="Form1" method="post" runat="server" class="cnt">
			<uc1:head id="Head1" runat="server"></uc1:head>
			<input type="text" style="display:none">
			<h1 class="title title-line">Sertifikat</h1>
			<br>
        ...
        <script type="text/javascript">
            function call(nomor) {
                popKontrakSertifikatEdit(nomor);
            }
        </script>
    </form>
</body>

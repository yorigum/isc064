...
<%@ Page language="c#" Inherits="ISC064.LEGAL.KontrakAJBTTD" CodeFile="KontrakAJBTTD.aspx.cs" %>
<!DOCTYPE html>
<html>
	<head>
		<title>Tanda Tangan AJB</title>
		...
		<meta name="sec" content="Kontrak - Tanda Tangan AJB">
	</head>
	<body class="body-padding" onkeyup="&#13;&#10;&#9;if(document.getElementById('backbtn')){if(event.keyCode==27)document.getElementById('backbtn').click()};&#13;&#10;&#9;if(document.getElementById('cancel')){if(event.keyCode==27)document.getElementById('cancel').click()}">
		<form id="Form1" method="post" runat="server" class="cnt">
			...
			<div id="pilih" runat="server">
				<h1 class="title title-line">Tanda Tangan AJB</h1>
					...
					<tr>
						...
						<td>
							<nobr>
								...
								<input type="button" value="&#xf073;" style="font-family: 'fontawesome'" class="btn" onclick="openCalendar('tglajb')" disabled="disabled"/>
                            </nobr>

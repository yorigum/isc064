<%@ Page Language="C#" CodeFile="KontrakApprovBatal.aspx.cs" Inherits="ISC064.LEGAL.KontrakApprovBatal" %>
			    ...
			    <div>
				  <table class="tb blue-skin" border="0">
				    ...
				    <asp:PlaceHolder ID="list" runat="server" />
						    ...
						    <asp:Button ID="save" runat="server" CssClass="btn btn-blue" Text="Save" Width="75" OnClick="save_Click"
							    AccessKey="s" />
			</div>
			</div>

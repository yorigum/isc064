<%@ Page language="c#" Inherits="ISC064.LEGAL.KontrakSertifikatProses" CodeFile="KontrakSertifikatProses.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html>
	<head>
		<title>Proses Sertifikat</title>
		...
		<meta name="sec" content="Kontrak - Proses Sertifikat">
	</head>
	<body class="body-padding" onkeyup="&#13;&#10;&#9;if(document.getElementById('backbtn')){if(event.keyCode==27)document.getElementById('backbtn').click()};&#13;&#10;&#9;if(document.getElementById('cancel')){if(event.keyCode==27)document.getElementById('cancel').click()}">
		<form id="Form1" method="post" runat="server" class="cnt">
			...
			<div id="pilih" runat="server">
				<h1 class="title title-line">Proses Sertifikat</h1>
			...
			<table id="selesai" cellspacing="5" runat="server">
                <tr>
					<td width="150">Tgl Proses Sertifikat</td>
					<td>:</td>
                ...
                <tr>
					...
					<td>:</td>
					<td><asp:textbox id="tbTgl" runat="server" cssclass="txt_center" width="75" font-size="8" ReadOnly="true"></asp:textbox><input type="button" value="&#xf073;" style="font-family: 'fontawesome'" class="btn" onclick="openCalendar('tbTgl')" disabled="disabled"/>
						<asp:label id="lblTgl" runat="server" forecolor="Red"></asp:label></td>
				</tr>
				<tr>

namespace ISC064.LEGAL
{
    ...
    public partial class HeadSertifikat : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, System.EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                string p = Db.SingleString("SELECT ISNULL((SELECT TOP 1 NoKontrak FROM MS_SERTIFIKAT WHERE NoKontrak < '" + NoKontrak + "' ORDER BY NoKontrak DESC),'')");
                string n = Db.SingleString("SELECT ISNULL((SELECT TOP 1 NoKontrak FROM MS_SERTIFIKAT WHERE NoKontrak > '" + NoKontrak + "' ORDER BY NoKontrak ASC),'')");
                ...
                if (rs.Rows.Count > 0)
                {
                    ...
                    //nokontrak.Text = "<a href='KontrakEdit.aspx?NoKontrak=" + rs.Rows[0]["NoKontrak"] + "'>"
                    //    + rs.Rows[0]["NoKontrak"] + "</a>";

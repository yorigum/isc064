<%@ Page language="c#" Inherits="ISC064.LEGAL.KontrakSTTTD" CodeFile="KontrakSTTTD.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html>
	<head>
		<title>Tanda Tangan Serah Terima</title>
	...
	<body class="body-padding" onkeyup="&#13;&#10;&#9;if(document.getElementById('backbtn')){if(event.keyCode==27)document.getElementById('backbtn').click()};&#13;&#10;&#9;if(document.getElementById('cancel')){if(event.keyCode==27)document.getElementById('cancel').click()}">
		<form id="Form1" method="post" runat="server" class="cnt">
			...
			<div id="pilih" runat="server">
				<h1 class="title title-line">Tanda Tangan Serah Terima</h1>
			...
			<div id="frm" runat="server">
				...
				<table cellspacing="5">
					...
					<tr>
						...
						<td>
							<nobr>
								...
								<input type="button" value="&#xf073;" class="btn" style="font-family: 'fontawesome'" onclick="openCalendar('tglst')" disabled="disabled"> </nobr>
                    ...
                    <tr>
						...
						<td>:</td>
						<td>
							<asp:textbox id="luasnett" runat="server" cssclass="txt_num" width="75" readonly="True"></asp:textbox>
							m2

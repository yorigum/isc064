<%@ Page language="c#" Inherits="ISC064.KOMISI.SkemaCFDel" CodeFile="SkemaCFDel.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head>
		<title>Delete Skema Closing Fee</title>
		...
		<meta name="sec" content="Setup Skema Closing Fee - Delete Skema Closing Fee">
	</head>
	<body class="body-padding" onkeyup="if(event.keyCode==27) history.back(-1)">
		<form id="Form1" method="post" runat="server">
			<div id="frm" runat="server">
				<input type="text" style="display:none">
				<h1 class="title title-line">Delete Skema Closing Fee</h1>
				<br>
				Keterangan :
			...
			<asp:label id="nodel" runat="server" visible="false">
				<h1>
					Skema Closing Fee Tidak Dapat Dihapus
				</h1>
				<br>
				<div class="plike">

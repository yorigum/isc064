<%@ Page Language="c#" Inherits="ISC064.KOMISI.RewardREdit" CodeFile="RewardREdit.aspx.cs" %>

<%@ Register TagPrefix="uc1" TagName="HeadRewardR" Src="HeadRewardR.ascx" %>
<%@ Register TagPrefix="uc1" TagName="NavRewardR" Src="NavRewardR.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head>
    <title>Edit Realisasi Pencairan Reward</title>
    ...
    <meta name="sec" content="Realisasi Pencairan Reward - Edit">
</head>
<body onkeyup="if(event.keyCode==27) window.close()">
    <form id="Form1" method="post" runat="server">
        <div class="content-header">
            <uc1:NavRewardR ID="NavRewardR" runat="server" Aktif="1"></uc1:NavRewardR>
        </div>
        <div class="tabdata">
            <div class="pad">
                <uc1:HeadRewardR ID="HeadRewardR" runat="server"></uc1:HeadRewardR>
                <table cellspacing="5">
                    <tr>
                        <td width="100%"></td>
                        <td>

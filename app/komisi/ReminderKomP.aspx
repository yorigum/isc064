<%@ Page Language="c#" Inherits="ISC064.KOMISI.ReminderKomP" CodeFile="ReminderKomP.aspx.cs" %>

<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html>
<head>
    <title>Reminder Komisi Yang Belum Diajukan</title>
    ...
    <meta name="sec" content="Reminder - Komisi Yang Belum Diajukan">
</head>
<body class="body-padding" onkeyup="if(event.keyCode==27)document.getElementById('cancel').click()">
    <form id="Form1" method="post" runat="server" class="cnt">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <h1 class="title title-line">Reminder Komisi Yang Belum Diajukan</h1>
        <p class="feed">
        ...
        <asp:Table ID="rpt" runat="server" CellSpacing="1" Width="80%" CssClass="tb blue-skin">
            <asp:TableRow HorizontalAlign="Left">
                ...
                <asp:TableHeaderCell>Nilai Cair</asp:TableHeaderCell>
            </asp:TableRow>
        </asp:Table>

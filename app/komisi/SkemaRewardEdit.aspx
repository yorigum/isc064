<%@ Page Language="c#" Inherits="ISC064.KOMISI.SkemaRewardEdit" CodeFile="SkemaRewardEdit.aspx.cs" %>

<%@ Register TagPrefix="uc1" TagName="HeadSkomReward" Src="HeadSkomReward.ascx" %>
<%@ Register TagPrefix="uc1" TagName="NavSkomReward" Src="NavSkomReward.ascx" %>
<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head>
    <title>Edit Skema Reward</title>
    ...
    <meta name="sec" content="Setup Skema Reward - Edit Skema Reward">
</head>
<body onkeyup="if(event.keyCode==27) window.close()">
    <form id="Form1" method="post" runat="server">
        <div class="content-header">
            <uc1:NavSkomReward ID="NavSkomReward" runat="server" Aktif="1"></uc1:NavSkomReward>
        </div>
        <div class="tabdata">
            <div class="pad">
                <uc1:HeadSkomReward ID="HeadSkomReward" runat="server"></uc1:HeadSkomReward>
                ...
                <asp:Table ID="tbRumus1" runat="server" CssClass="tb blue-skin" CellSpacing="1">
                    <asp:TableRow>
                        <asp:TableHeaderCell ColumnSpan="3"><span style="font-size:large;">Rumus Reward</span></asp:TableHeaderCell>
                    </asp:TableRow>
                    <asp:TableRow>
                ...
                <asp:Table ID="tbRumus2" runat="server" CssClass="tb blue-skin" CellSpacing="1">
                    <asp:TableRow>
                        <asp:TableHeaderCell ColumnSpan="5"><span style="font-size:large;">Rumus Reward</span></asp:TableHeaderCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableHeaderCell>Level</asp:TableHeaderCell>
        ...
        <script language="javascript">
            function hapusbaris(nomor, baris) {
                if (confirm('Hapus satu baris detail ini dari skema?\nPerhatian bahwa data akan dihapus secara PERMANEN.')) {
                    location.href = 'SkemaRewardEdit.aspx?Act=del&Tipe=Skema&Nomor=' + nomor + '&Baris=' + baris;
                }
            }
            function hapusbarisTerm(nomor, baris) {
                if (confirm('Hapus satu baris termin ini dari skema?\nPerhatian bahwa data akan dihapus secara PERMANEN.')) {
                    ...
                    location.href = 'SkemaRewardEdit.aspx?Act=del&Tipe=Term&Nomor=' + nomor + '&Baris=' + baris;
                }
            }
        </script>
    </form>

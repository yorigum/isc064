<%@ Page language="c#" Inherits="ISC064.KOMISI.CFRDel" CodeFile="CFRDel.aspx.cs" %>
<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html>
	<head>
		<title>Delete Realisasi Pencairan Closing Fee</title>
		...
		<meta name="sec" content="Closing Fee - Delete Realisasi Pencairan Closing Fee">
	</head>
	<body class="body-padding" onkeyup="if(event.keyCode==27) history.back(-1)">
        ...
        <table style="border: 1px solid #DCDCDC" cellspacing="5">
            <tr>
                ...
                <td id="trSales" runat="server" visible="false">
        ...
        <table class="tb blue-skin" cellspacing="1">
            <tr align="left" valign="bottom">
                <th></th>
                <th>No. Realisasi Closing Fee</th>
                <th>Tgl. Realisasi</th>
                <th>Penerima</th>
            </tr>
            <tr>

<%@ Page language="c#" Inherits="ISC064.KOMISI.DaftarCFP" CodeFile="DaftarCFP.aspx.cs" %>
<!DOCTYPE html>
<html>
	<head>
		<title>Daftar Pengajuan Pencairan Closing Fee</title>
		...
		<meta name="sec" content="(Pop-Up) Daftar Pengajuan Pencairan Closing Fee">
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:table id="rpt" runat="server" cssclass="tb blue-skin" cellspacing="1">
				<asp:tablerow horizontalalign="Left" verticalalign="Bottom">
					<asp:tableheadercell width="160">No. Pengajuan</asp:tableheadercell>
                    <asp:tableheadercell width="75">Tgl. Pengajuan</asp:tableheadercell>

...
<%@ Page Language="c#" Inherits="ISC064.KOMISI.Laporan.MasterKomisi" CodeFile="MasterKomisi.aspx.cs" %>
...
<body onkeyup="if(event.keyCode==27&amp;&amp;confirm('Apakah anda ingin menutup laporan ini?'))window.close()">
    <form id="Form1" method="post" runat="server">
        ...
        <table id="param" runat="server" width="100%" cellspacing="3">
            <tr>
                <td>
                    ...
                    <h1 id="judul" runat="server" class="title title-line">Laporan Master Komisi
                    </h1>
                   <%-- <p>
                        <b>Sales :</b>
                        <br>
        ...
        <br />
        <asp:Table ID="rpt" runat="server" Width="100%" CssClass="tb blue-skin" CellSpacing="1">

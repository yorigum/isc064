...
<%@ Page Language="c#" Inherits="ISC064.KOMISI.Laporan.MasterCF" CodeFile="MasterCF.aspx.cs" %>
        ...
        <table id="param" runat="server" width="100%" cellspacing="3">
            <tr>
                <td>
                    ...
                    <h1 id="judul" runat="server" class="title title-line">Laporan Master Closing Fee
                    </h1>
                   <%-- <p>
                        <b>Sales :</b>
                        <br>

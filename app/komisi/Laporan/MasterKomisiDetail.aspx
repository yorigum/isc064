...
<%@ Page Language="c#" Inherits="ISC064.KOMISI.Laporan.MasterKomisiDetail" CodeFile="MasterKomisiDetail.aspx.cs" %>
        ...
        <table id="param" runat="server" width="100%" cellspacing="3">
            <tr>
                <td>
                    ...
                    <h1 id="judul" runat="server" class="title title-line">Laporan Master Komisi Detail
                    </h1>
                   <%-- <p>
                        <b>Sales :</b>
                        <br>

<%@ Page language="c#" Inherits="ISC064.KOMISI.DaftarKomisi" CodeFile="DaftarKomisi.aspx.cs" %>
<!DOCTYPE html>
<html>
	<head>
		...
		<meta name="sec" content="(Pop-Up) Daftar Komisi">
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:table id="rpt" runat="server" cssclass="tb blue-skin" cellspacing="1">
				<asp:tablerow horizontalalign="Left" verticalalign="Bottom">
					<asp:tableheadercell width="160">Kode Komisi</asp:tableheadercell>

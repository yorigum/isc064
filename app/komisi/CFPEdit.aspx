<%@ Page Language="c#" Inherits="ISC064.KOMISI.CFPEdit" CodeFile="CFPEdit.aspx.cs" %>

<%@ Register TagPrefix="uc1" TagName="HeadCFP" Src="HeadCFP.ascx" %>
<%@ Register TagPrefix="uc1" TagName="NavCFP" Src="NavCFP.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head>
    <title>Edit Pengajuan Pencairan Closing Fee</title>
    ...
    <meta name="sec" content="Pengajuan Pencairan Closing Fee - Edit">
</head>
<body onkeyup="if(event.keyCode==27) window.close()">
    <form id="Form1" method="post" runat="server">
        <div class="content-header">
            <uc1:NavCFP ID="NavCFP" runat="server" Aktif="1"></uc1:NavCFP>
        </div>
        <div class="tabdata">
            <div class="pad">
                <uc1:HeadCFP ID="HeadCFP" runat="server"></uc1:HeadCFP>
                <table cellspacing="5">
                    <tr>
                        <td width="100%"></td>
                        <td>
                ...
                <asp:Table ID="tb" runat="server" CssClass="tb blue-skin" CellSpacing="1">
                    <asp:TableRow>
                        <asp:TableHeaderCell ColumnSpan="7"><span style="font-size:large;">Detail</span></asp:TableHeaderCell>
                    </asp:TableRow>
                    <asp:TableRow>

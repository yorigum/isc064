<%@ Page language="c#" Inherits="ISC064.KOMISI.TerminKomisi" CodeFile="TerminKomisi.aspx.cs" %>
				...
				<tr valign="top">
					<td width="49%">					    
                        ...
                        <p style="font:bold 10pt">
                            <asp:LinkButton ID="RegSkemaIn" runat="server" onclick="RegSkemaIn_Click">Daftar Termin Baru</asp:LinkButton>
                        </p>
                        <p style="font:bold 10pt">&nbsp;</p>
                        <p style="font:bold 10pt">
                        ...
                        <p style="font:bold 10pt">&nbsp;</p>
                        <p style="font:bold 10pt">Termin Aktif</p>
						<ul id="aktifIntern" runat="server" class="plike">
						</ul>
						<br>
						<p style="font:bold 10pt">Termin Inaktif</p>

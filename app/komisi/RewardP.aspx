<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RewardP.aspx.cs" Inherits="ISC064.KOMISI.RewardP" %>
...
<head>
    ...
    <meta name="sec" content="Pengajuan Pencairan Reward">
</head>
<body class="body-padding">
    <form id="Form1" method="post" runat="server" class="cnt">
        ...
        <table style="border: 1px solid #DCDCDC" cellspacing="5">
            <tr>
                <td>
                    <input type="button" style="" class="btn btn-blue" value="Search" show-modal='#ModalPopUp' modal-title='Daftar Pengajuan Pencairan Reward' modal-url='DaftarRewardP.aspx' id="search" runat="server" name="search" accesskey="s">
                </td>
                <td><b>Dari</b></td>
                <td>

<%@ Page language="c#" Inherits="ISC064.KOMISI.TerminKomisiDel" CodeFile="TerminKomisiDel.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
	<head>
		<title>Delete Termin Komisi</title>
		...
		<meta name="sec" content="Setup Termin Komisi - Delete Termin Komisi">
	</head>
	<body class="body-padding" onkeyup="if(event.keyCode==27) history.back(-1)">
		<form id="Form1" method="post" runat="server">
			<div id="frm" runat="server">
				<input type="text" style="display:none">
				<h1 class="title title-line">Delete Termin Komisi</h1>
				<br>
				Keterangan :
			...
			<asp:label id="nodel" runat="server" visible="false">
				<h1>
					Termin Komisi Tidak Dapat Dihapus
				</h1>
				<br>
				<div class="plike">

...
{
    public partial class KomisiRRegis1 : System.Web.UI.Page
    {
        ...
        protected void display_Click(object sender, System.EventArgs e)
        {
            ...
            for (int i = 0; i < rs.Rows.Count; i++)
            {
                ...
                c = new TableCell();
                c.Text = "<a href=\"KomisiRRegis2.aspx?id=" + rs.Rows[i]["NoKomisiP"].ToString() + "&Project=" + project.SelectedValue + "\">Next</a>";
                c.HorizontalAlign = HorizontalAlign.Left;
                r.Cells.Add(c);

                c = new TableCell();
                c.Text = rs.Rows[i]["NoKomisiP"].ToString();
                c.HorizontalAlign = HorizontalAlign.Left;
                r.Cells.Add(c);

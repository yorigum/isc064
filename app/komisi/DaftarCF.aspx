<%@ Page language="c#" Inherits="ISC064.KOMISI.DaftarCF" CodeFile="DaftarCF.aspx.cs" %>
<!DOCTYPE html>
<html>
	<head>
		<title>Daftar Closing Fee</title>
		...
		<meta name="sec" content="(Pop-Up) Daftar Closing Fee">
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:table id="rpt" runat="server" cssclass="tb blue-skin" cellspacing="1">
				<asp:tablerow horizontalalign="Left" verticalalign="Bottom">
					<asp:tableheadercell width="160">Kode CF</asp:tableheadercell>

<%@ Page Language="c#" Inherits="ISC064.KOMISI.CFREdit" CodeFile="CFREdit.aspx.cs" %>

<%@ Register TagPrefix="uc1" TagName="HeadCFR" Src="HeadCFR.ascx" %>
<%@ Register TagPrefix="uc1" TagName="NavCFR" Src="NavCFR.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head>
    <title>Edit Realisasi Pencairan Closing Fee</title>
    ...
    <meta name="sec" content="Realisasi Pencairan Closing Fee - Edit">
</head>
<body onkeyup="if(event.keyCode==27) window.close()">
    <form id="Form1" method="post" runat="server">
        <div class="content-header">
            <uc1:NavCFR ID="NavCFR" runat="server" Aktif="1"></uc1:NavCFR>
        </div>
        <div class="tabdata">
            <div class="pad">
                <uc1:HeadCFR ID="HeadCFR" runat="server"></uc1:HeadCFR>
                <table cellspacing="5">
                    <tr>
                        <td width="100%"></td>
                        <td>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <asp:TextBox ID="tipe" runat="server" Width="250" CssClass="txt" Enabled="false"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                ...
                <asp:Table ID="tb" runat="server" CssClass="tb blue-skin" CellSpacing="1">
                    <asp:TableRow>
                        <asp:TableHeaderCell ColumnSpan="8"><span style="font-size:large;">Detail</span></asp:TableHeaderCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        ...
                        <asp:TableHeaderCell CssClass="right">Nilai Closing Fee</asp:TableHeaderCell>
                        <asp:TableHeaderCell CssClass="right">Nilai PPH</asp:TableHeaderCell>
                    </asp:TableRow>
                </asp:Table>
                <br />
                <table height="50">

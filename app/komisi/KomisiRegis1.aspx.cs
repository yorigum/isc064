...
{
    public partial class KomisiRegis1 : System.Web.UI.Page
    {
        ...
        protected void Fill()
        {
            ...
            for (int i = 0; i < rs.Rows.Count; i++)
            {
                ...
                if (rs.Rows[i]["CFID"].ToString() == "")
                    r.Attributes["style"] = "color:#FF0000;";
        ...
        {
            Response.Redirect("KomisiRegis2.aspx?Dari=" + dari.Text + "&Sampai=" + sampai.Text + "&Sales=" + sales.SelectedValue + "&Project=" + project.SelectedValue);
        }

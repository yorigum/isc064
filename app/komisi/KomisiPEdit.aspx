<%@ Page Language="c#" Inherits="ISC064.KOMISI.KomisiPEdit" CodeFile="KomisiPEdit.aspx.cs" %>

<%@ Register TagPrefix="uc1" TagName="HeadKomP" Src="HeadKomP.ascx" %>
<%@ Register TagPrefix="uc1" TagName="NavKomP" Src="NavKomP.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head>
    <title>Edit Pengajuan Pencairan Komisi</title>
    ...
    <meta name="sec" content="Pengajuan Pencairan Komisi - Edit">
</head>
<body onkeyup="if(event.keyCode==27) window.close()">
    <form id="Form1" method="post" runat="server">
        <div class="content-header">
            <uc1:NavKomP ID="NavKomP" runat="server" Aktif="1"></uc1:NavKomP>
        </div>
        <div class="tabdata">
            <div class="pad">
                <uc1:HeadKomP ID="HeadKomP" runat="server"></uc1:HeadKomP>
                <table cellspacing="5">
                    <tr>
                        <td width="100%"></td>
                        <td>
                ...
                <asp:Table ID="tb" runat="server" CssClass="tb blue-skin" CellSpacing="1">
                    ...
                    <asp:TableRow>
                        ...
                        <asp:TableHeaderCell>Termin</asp:TableHeaderCell>

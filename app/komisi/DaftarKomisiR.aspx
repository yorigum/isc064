<%@ Page language="c#" Inherits="ISC064.KOMISI.DaftarKomisiR" CodeFile="DaftarKomisiR.aspx.cs" %>
<!DOCTYPE html>
<html>
	<head>
		<title>Daftar Realisasi Pencairan Komisi</title>
		...
		<meta name="sec" content="(Pop-Up) Daftar Realisasi Pencairan Komisi">
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:table id="rpt" runat="server" cssclass="tb blue-skin" cellspacing="1">
				<asp:tablerow horizontalalign="Left" verticalalign="Bottom">
					<asp:tableheadercell width="160">Kode Realisasi</asp:tableheadercell>

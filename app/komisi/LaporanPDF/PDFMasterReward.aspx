...
<%@ Page Language="c#" Inherits="ISC064.KOMISI.Laporan.MasterReward" CodeFile="PDFMasterReward.aspx.cs" %>
        ...
        <table id="param" runat="server" width="100%" cellspacing="3">
            <tr>
                <td>
                    ...
                    <h1 id="judul" class="title title-line" runat="server">Laporan Master Reward
                    </h1>

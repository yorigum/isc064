<%@ Page language="c#" Inherits="ISC064.KOMISI.SkemaCFRegis" CodeFile="SkemaCFRegis.aspx.cs" %>
...
<html>
	...
	<body class="default-content">
		<form id="Form1" method="post" runat="server" class="cnt">
			...
			<h1 class="title title-line">Setup Skema Closing Fee</h1>
			<br>
				...
				<tr valign="top">
					<td>
						...
						<table cellspacing="5">
							...
							<tr>
                                <td width="20%" valign="top">Periode Closing Fee</td>
							...
							<tr>
								<td colspan="6">
                                    <asp:Table ID="tbRumus1" runat="server" CssClass="tb blue-skin" CellSpacing="1">
                                        <asp:TableRow>
                                            <asp:TableHeaderCell ColumnSpan="5"><span style="font-size:large;">Rumus Closing Fee</span></asp:TableHeaderCell>
                                        </asp:TableRow>
                                        <asp:TableRow>
                                            <asp:TableHeaderCell>Level</asp:TableHeaderCell>
                                            <asp:TableHeaderCell>Tipe Tarif</asp:TableHeaderCell>
                                            <asp:TableHeaderCell>Tarif CF</asp:TableHeaderCell>
                                    ...
                                    <asp:Table ID="tbRumus2" runat="server" CssClass="tb blue-skin" CellSpacing="1">
                                        <asp:TableRow>
                                            <asp:TableHeaderCell ColumnSpan="8"><span style="font-size:large;">Rumus Closing Fee</span></asp:TableHeaderCell>
                                        </asp:TableRow>
                                        <asp:TableRow>
                                            <asp:TableHeaderCell>Level</asp:TableHeaderCell>
                                            ...
                                            <asp:TableHeaderCell>Tipe Tarif</asp:TableHeaderCell>
                                            <asp:TableHeaderCell>Tarif Closing Fee</asp:TableHeaderCell>
                                            <asp:TableHeaderCell>Potong Komisi</asp:TableHeaderCell>
                                            <asp:TableHeaderCell></asp:TableHeaderCell>
                                        </asp:TableRow>
                                        <asp:tablerow horizontalalign="Left">
                                        ...
                                        <asp:tablerow horizontalalign="Left">
                                            <asp:TableCell width="75" ColumnSpan="8">

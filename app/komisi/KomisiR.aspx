<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KomisiR.aspx.cs" Inherits="ISC064.KOMISI.KomisiR" %>
...
<head>
    ...
    <meta name="sec" content="Realisasi Pencairan Komisi">
</head>
<body class="body-padding">
    <form id="Form1" method="post" runat="server" class="cnt">
        ...
        <table style="border: 1px solid #DCDCDC" cellspacing="5">
            <tr>
                <td>
                    <input type="button" style="" class="btn btn-blue" value="Search" show-modal='#ModalPopUp' modal-title='Daftar Realisasi Pencairan Komisi' modal-url='DaftarKomisiR.aspx' id="search" runat="server" name="search" accesskey="s">
                </td>
                <td><b>Dari</b></td>
                <td>

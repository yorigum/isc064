...
namespace ISC064.KOMISI
{
    public partial class SkemaKomisi : System.Web.UI.Page
    {
        ...
        private void FillTable()
        {
            ...
            //Isi skema aktif
            DataTable rs = Db.Rs("SELECT * FROM REF_SKOM WHERE Inaktif = 0 AND Project = '" + project.SelectedValue + "'");
            ...
            for (int i = 0; i < rs.Rows.Count; i++)
            {
                ...
                sb.Append("<li>"
                    + "<a href=\"javascript:popSkom('" + rs.Rows[i]["NoSkema"].ToString() + "')\">"
            ...
            rs = Db.Rs("SELECT * FROM REF_SKOM WHERE Inaktif = 1 AND Project = '" + project.SelectedValue + "'");
        ...
        {
            Response.Redirect("SkemaKomisiRegis.aspx");
        }
    }
}

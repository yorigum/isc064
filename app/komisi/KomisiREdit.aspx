<%@ Page Language="c#" Inherits="ISC064.KOMISI.KomisiREdit" CodeFile="KomisiREdit.aspx.cs" %>

<%@ Register TagPrefix="uc1" TagName="HeadKomR" Src="HeadKomR.ascx" %>
<%@ Register TagPrefix="uc1" TagName="NavKomR" Src="NavKomR.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head>
    <title>Edit Realisasi Pencairan Komisi</title>
    ...
    <meta name="sec" content="Realisasi Pencairan Komisi - Edit">
</head>
<body onkeyup="if(event.keyCode==27) window.close()">
    <form id="Form1" method="post" runat="server">
        <div class="content-header">
            <uc1:NavKomR ID="NavKomR" runat="server" Aktif="1"></uc1:NavKomR>
        </div>
        <div class="tabdata">
            <div class="pad">
                <uc1:HeadKomR ID="HeadKomR" runat="server"></uc1:HeadKomR>
                <table cellspacing="5">
                    <tr>
                        <td width="100%"></td>
                        <td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KomisiP.aspx.cs" Inherits="ISC064.KOMISI.KomisiP" %>

<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>Pengajuan Pencairan Komisi</title>
    ...
    <meta name="sec" content="Pengajuan Pencairan Komisi">
</head>
<body class="body-padding">
    <form id="Form1" method="post" runat="server" class="cnt">
        <uc1:Head ID="Head1" runat="server"></uc1:Head>
        <input type="text" style="display: none">
        <h1 class="title title-line">Pengajuan Pencairan Komisi</h1>
        <br />
        <table style="border: 1px solid #DCDCDC" cellspacing="5">
            <tr>
                <td>
                    <input type="button" style="" class="btn btn-blue" value="Search" show-modal='#ModalPopUp' modal-title='Daftar Pengajuan Pencairan Komisi' modal-url='DaftarKomisiP.aspx' id="search" runat="server" name="search" accesskey="s">
                </td>
                <td><b>Dari</b></td>
                <td>

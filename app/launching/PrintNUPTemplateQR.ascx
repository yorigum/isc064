<%@ Control Language="c#" Inherits="ISC064.LAUNCHING.PrintNUPTemplateQR" CodeFile="PrintNUPTemplateQR.ascx.cs" %>
...
<div id="divPrint" runat="server" visible="false">
    <div style="width: 100%">
        <asp:Image runat="server" ID="QRImage" Width="10%" />
        ...
        <table style="width: 100%">
            <tr>
                ...
                <td>
                    <div style="border: 1px solid black; width: 15px; height: 10px; float: left">
                    </div>

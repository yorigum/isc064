<%@ Page Language="c#" Inherits="ISC064.LAUNCHING.NUPEdit" CodeFile="NUPEdit.aspx.cs" %>
        ...
        <div class="pad">
            ...
            <table cellspacing="5">
                <tr>
					...
					<td class="printhref">
                        <a id="printTTS" runat="server"><b>TTS 1</b></a>
                    </td>
					<td class="printhref"><a id="printTTS2" runat="server" visible="false"><b>TTS 2</b></a></td>
					
					<%--<td class="printhref"><a id="printNUP" runat="server"><b>NUP</b></a></td>--%>
					<td width="100%"></td>
                    <%--<td>
                    ...
                    <td>
                        ...
                        <table cellspacing="5" style="width: 430px; float: right;">
                            ...
                            <tr id="trsave" runat="server">
                                ...
                                <td colspan="2">
                                    <input id="cancel" runat="server" class="btn" onclick="javascript:window.close(); return false;"

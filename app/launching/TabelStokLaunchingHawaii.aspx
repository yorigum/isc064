...
<%@ Page language="c#" Inherits="ISC064.LAUNCHING.TabelStokLaunchingHawaii" CodeFile="TabelStokLaunchingHawaii.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Cluster Hawaii</title>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<div align="center">
				<h2 style="FONT-SIZE:12pt">CLUSTER HAWAII</h2>
				<br />

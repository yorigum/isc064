...
<%@ Page Language="c#" Inherits="ISC064.LAUNCHING.NUPDaftarCustomer" CodeFile="NUPDaftarCustomer.aspx.cs" %>
            ...
            <td>
                <table cellspacing="5" style="width: 400px; float: left;">
                    ...
                    <tr>
                        ...
                        <td>
                            <label><input type="radio" id="rbBeda" name="pilihcara" onclick="javascript:bedaisi()" />BEDA dengan KTP</label>
                            <label><input type="radio" id="rbSama" name="pilihcara"  onclick="javascript:samaisi()" />SAMA dengan KTP</label>
                        </td>
                    </tr>
                ...
                <table cellspacing="5" style="width: 430px; float: right;">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <input id="cancel" runat="server" class="btn" onclick="location.href='NUPDaftarCustomer.aspx'; return false;"

...
<%@ Page Language="c#" Inherits="ISC064.LAUNCHING.TTNUPRegistrasi" CodeFile="TTNUPRegistrasi.aspx.cs" %>
...
<head>
    ...
    <meta name="sec" content="Tanda Terima Sementara - Registrasi Pembayaran NUP">
</head>
<style type="text/css">
    .sm TD
    {
...
<body style="text-align: center">
    ...
    <p style="text-align: left;">
        <b style="font-size:x-large;">Registrasi Pembayaran NUP</b>
        <br />
        <br />
        Halaman 1 dari 2</p>
    <br>
    <table style="border-right: #dcdcdc 1px solid; border-top: #dcdcdc 1px solid; border-left: #dcdcdc 1px solid;
        border-bottom: #dcdcdc 1px solid; text-align: center;" cellspacing="5">
        <tr>
    ...
    <script language="javascript">
			...
			{			
					location.href='TTSRegistrasiNUP.aspx?Ref='+ref+'&Tipe='+tipe;
			}
    </script>

<%@ Page Language="c#" Inherits="ISC064.LAUNCHING.PanggilNUPTampilALL" CodeFile="PanggilNUPTampilALL.aspx.cs" %>
    ...
    <form id="Form1" method="post" runat="server" class="cnt">
        ...
        <div style="width: 100%; padding-top: 10px; padding-left: 80px" align="center">
            <table style="margin: 0;" width="100%">
                <tr>
                    <td>
                        <img src="../Media/LogoPerum.jpg" /></td>
                    <td style="vertical-align: top; font-size: 40px; text-align: center">DAFTAR AKTIVASI NPU</td>
                    <td>
                        <img src="../Media/logo-kai.png" width="250px" height="80px" /></td>
                </tr>
                <tr>
            ...
            <table style="margin: 0; font-size: 30px;">
                <tr>
                    ...
                    <td rowspan="2">
                        <table style="margin: 0; font-size: 30px">
                            <tr>
                                <td colspan="3" style="vertical-align: top;">Stock Unit Rusunami</td>
                                <td>&nbsp;</td>
                                <td colspan="3" style="vertical-align: top;">Stock Unit Apartemen</td>
                            </tr>
                            <tr>
                                <td width="150px" style="vertical-align: top;">Studio
                                </td>
                                ...
                                <td style="vertical-align: top;">:</td>
                                <td style="vertical-align: top;">
                                    <asp:Label ID="std2" runat="server"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td width="150px">1 BR 
                                ...
                                <td>:</td>
                                <td>
                                    <asp:Label ID="one" runat="server"></asp:Label>
                                </td>
                                <td>&nbsp;</td>
                                <td width="150px">1 BR 
                                </td>
                                <td>:</td>
                                <td>
                                    <asp:Label ID="one2" runat="server"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td style="vertical-align: top;" width="150px">2 BR
                                </td>
                                <td style="vertical-align: top;">:</td>
                                <td style="vertical-align: top;">
                                    <asp:Label ID="two" runat="server"></asp:Label>
                                </td>
                                <td>&nbsp;</td>
                                <td style="vertical-align: top;" width="150px">2 BR
                                </td>
                                <td style="vertical-align: top;">:</td>
                                <td style="vertical-align: top;">
                                    <asp:Label ID="two2" runat="server"></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </td>

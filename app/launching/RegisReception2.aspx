...
<%@ Page Language="c#" Inherits="ISC064.LAUNCHING.RegisReception2" CodeFile="RegisReception2.aspx.cs" %>
...
<head>
    ...
    <meta name="sec" content="NUP - Aktivasi NUP (Hal. 2 dari 3)">
    <style type="text/css">
        .sm TD {
            font-weight: normal;
            font-size: 8pt;
    ...
    <form id="Form1" method="post" runat="server" class="cnt">
        ...
        <table cellspacing="0" cellpadding="20">
            <tr valign="top">
                <td style="width: 50%;">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="nomorNUP" runat="server" CssClass="txt" Width="200" ReadOnly="True"
                                    Style="border: none; font-weight: bold;"></asp:Label>
                            </td>
                        </tr>                      
                        <tr>
                            <td>Tanggal NUP
                            ...
                            <td>
                                <asp:Label ID="tglNUP" runat="server" Width="100px" CssClass="txt_center" ReadOnly="True"
                                    Style="border: none; text-align: left;" Height="20px"></asp:Label>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="nama" runat="server" CssClass="txt" Width="250" MaxLength="100"
                                    ReadOnly="True" Style="border: none; text-align: left;"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>No. Telp / HP
                            ...
                            <td>
                                <asp:Label ID="ctelp" runat="server" CssClass="txt" Width="70" ReadOnly="True"
                                    Style="border: none; text-align: left;"></asp:Label>
                                &nbsp;/&nbsp;
                            <asp:Label ID="chp" runat="server" CssClass="txt" Width="90" ReadOnly="True" Style="border: none; text-align: left;"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>No. NIK
                            ...
                            <td>
                                <asp:Label ID="noktp" runat="server" CssClass="txt" Width="140" MaxLength="50"
                                    ReadOnly="True" Style="border: none; text-align: left;"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="npwp" runat="server" CssClass="txt" Width="140"
                                    ReadOnly="True" Style="border: none; text-align: left;"></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <table>
                        <tr>
                            ...
                            <td colspan="2">
                                <input id="Cancel" runat="server" class="btn" onclick="location.href = 'Index.html'; return false;"
                ...
                <td style="width: 50%; display: none;"></td>
            </tr>
        </table>

    ...
    protected void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (persen != "" && ket != "")
            {
                ...
                try { persen1.Text = p[0]; }
                catch { }
                try { persen2.Text = p[1]; }
                catch { }
                try { persen3.Text = p[2]; }
                catch { }
                try { persen4.Text = p[3]; }
                catch { }
                try { persen5.Text = p[4]; }
                catch { }
                try { persen6.Text = p[5]; }
                catch { }
                try { persen7.Text = p[6]; }
                catch { }
                try { persen8.Text = p[7]; }
                catch { }
                try { persen9.Text = p[8]; }
                catch { }
                try { persen10.Text = p[9]; }
                catch { }

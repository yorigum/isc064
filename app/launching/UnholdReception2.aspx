...
<%@ Page Language="c#" Inherits="ISC064.LAUNCHING.UnholdReception2" CodeFile="UnholdReception2.aspx.cs" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head>
    <title>NUP - Unhold Aktivasi</title>
    ...
    <meta name="sec" content="NUP - Cancel Aktivasi (Hal. 2 dari 2)">
    <style type="text/css">
        .sm TD
        {
            font-weight: normal;

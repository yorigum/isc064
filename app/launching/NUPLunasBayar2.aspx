...
<%@ Page Language="c#" Inherits="ISC064.LAUNCHING.NUPLunasBayar2" CodeFile="NUPLunasBayar2.aspx.cs" %>
            ...
            <td>
                ...
                <table cellspacing="5" style="width: 420px; float: right;">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <input id="cancel" runat="server" class="btn" onclick="location.href='NUPLunasBayar.aspx'; return false;"

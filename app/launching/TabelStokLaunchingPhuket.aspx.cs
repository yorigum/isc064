...
{
    public partial class TabelStokLaunchingPhuket : System.Web.UI.Page
	{
        ...
        private void PrintHeader()
        {
            ...
            c = new TableCell(); c.CssClass = "h"; c.Text = "B1";
            r.Cells.Add(c);

            c = new TableCell(); c.CssClass = "h"; c.Text = "B2";
            r.Cells.Add(c);

            c = new TableCell(); c.CssClass = "h"; c.Text = "B3";
            r.Cells.Add(c);

            c = new TableCell(); c.CssClass = "h"; c.Text = "B5";
            r.Cells.Add(c);

            c = new TableCell(); c.CssClass = "h"; c.Text = "B6";
            r.Cells.Add(c);

            c = new TableCell(); c.CssClass = "h"; c.Text = "B7";
            r.Cells.Add(c);

            c = new TableCell(); c.CssClass = "h"; c.Text = "B8";
            r.Cells.Add(c);   
                ...
                if (rs.Rows[0]["Status"].ToString() == "B")
                {
                    ...
                    if (c != 0)
                    {
                        ...
                        if (r >= 30)
                            ...
                            color = Color.Yellow; //sold under 30%

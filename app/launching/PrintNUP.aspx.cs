...
namespace ISC064.LAUNCHING
{
    public partial class PrintNUP : System.Web.UI.Page
    {
        ...
        {
            PrintNUPTemplateBaru uc = (PrintNUPTemplateBaru)Page.LoadControl("PrintNUPTemplateBaru.ascx");
            uc.NoNUP = NoNUP;
        ...
        private void Fill()
        {
            cancel.Attributes["onclick"] = "location.href='NUPEdit.aspx?NoNUP=" + NoNUP + "'";
            //cancel2.Attributes["onclick"] = "location.href='KontrakEdit.aspx?NoKontrak="+NoKontrak+"'";

            string strSql = "SELECT PrintNUP FROM MS_NUP WHERE NoNUP = '" + NoNUP + "'";
        ...
        private void Tampil()
        {
            ...
            int c = Db.SingleInteger("SELECT PrintNUP FROM MS_NUP WHERE NoNUP='" + NoNUP + "'");
            string Tipe = Db.SingleString("SELECT Tipe FROM MS_NUP WHERE NoNUP='" + NoNUP + "'");

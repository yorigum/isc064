...
namespace ISC064.LAUNCHING
{
	public partial class PrintBKM : System.Web.UI.Page
	{
		...
		private void Fill()
		{
			...
			string strSql = "SELECT PrintBKM FROM ISC064_FINANCEAR..MS_TTS WHERE Status = 'POST' AND NoTTS = " + NoTTS;
		...
		private void Tampil()
		{
			...
			//increment
            Db.Execute("UPDATE ISC064_FINANCEAR..MS_TTS SET PrintBKM = PrintBKM + 1 WHERE NoTTS = " + NoTTS);

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Nup.aspx.cs" Inherits="ISC064.LAUNCHING.Nup" %>
...
<body onkeyup="&#13;&#10;&#9;if(document.getElementById('backbtn')){if(event.keyCode==27)document.getElementById('backbtn').click()};&#13;&#10;&#9;if(document.getElementById('cancel')){if(event.keyCode==27)document.getElementById('cancel').click()}">
    ...
    <br />
    <br />
    <div style="width: 30%; margin-left: 35%;" id="pilih" runat="server">
        <table style="width: 100%;" class="tbPilihan">
            <tr>
                <%-- <td style="width: 30%; text-align: center; font-size: 20pt; height: 200px;" class="masuk"
                    onclick>
                    <a href="NupDaftar.aspx">
                        <img src="Image/newnup.png" style="width: 80px; height: 80px;">
                        <br />
                        Register
                        <br />
                        Platinum<br />
                ...
                <td style="width: 50%; text-align: center; font-size: 20pt;" class="masuk">
                    <a href="RegisReception.aspx">
                        <img src="Image/reception_icon.jpg" style="width: 80px; height: 80px;">
                        <br />
                        Registrasi </a>
                </td>
                <%--<td style="width: 30%; text-align: center; font-size: 20pt;" class="masuk">
                    <a href="KonfirmasiNUP.aspx">
                        <img src="Image/registration.jpg" style="width: 80px; height: 80px;">
                        <br />
                        Konfirmasi<br />
                        NUP</a>
                </td>--%>

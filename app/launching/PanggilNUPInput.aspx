<%@ Page Language="c#" Inherits="ISC064.LAUNCHING.PanggilNUPInput" CodeFile="PanggilNUPInput.aspx.cs" %>
...
<body class="body-padding">
    ...
    <h1>
        Halaman Panggil NUP di Layar Utama</h1>
    ...
    <table style="border: 1px solid #DCDCDC" cellspacing="5">
        <tr>
            ...
            <td>
                <asp:TextBox ID="input" runat="server" Width="20px" MaxLength="2">0</asp:TextBox>
            ...
            <td>
                <asp:DropDownList ID="pilihhhh" runat="server">

<%@ Page Language="c#" Inherits="ISC064.LAUNCHING.PanggilNUPManual" CodeFile="PanggilNUPManual.aspx.cs" %>

<%@ Register TagPrefix="uc1" TagName="Head" Src="Head.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head>
    <title>NUP Pemanggilan Manual</title>
    ...
    <meta name="sec" content="NUP - Pemanggilan Nomor Manual (Voice Call)">
</head>
<style type="text/css">
    .sm TD
    {
    ...
    <uc1:Head ID="Head1" runat="server"></uc1:Head>
     <div>
        ...
        <center><table align="center">
            ...
            <tr>
                <td colspan="3" align="center" style="font-size:30px;font-weight:bold;padding:10px;"><asp:TextBox runat="server" ID="nomor" Text="-" style="text-align:center;padding:5px;width:100px;"></asp:TextBox></td>
            </tr>
            <tr>
                <td align="center">

<%@ Page language="c#" Inherits="ISC064.NUP.NUPLunasBayarFin" CodeFile="NUPLunasBayarFin.aspx.cs" %>
...
<html>
	...
	<body>
		<form id="Form1" method="post" runat="server" class="cnt">
			...
			<br>
			<h1><a id="asp" runat="server">Print TTS Pembayaran NUP</a></h1>
            <br />
            <h1><a id="asp2" runat="server">Print TTS Pelunasan NUP</a></h1>
		</form>
	</body>
</html>

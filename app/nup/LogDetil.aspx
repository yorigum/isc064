<%@ Page language="c#" Inherits="ISC064.NUP.LogDetil" CodeFile="LogDetil.aspx.cs" %>
<!DOCTYPE html>
<html lang="en">
	<head>
	...
	<body class="body-padding pop" onkeyup="if(event.keyCode==27)window.close()"
		...
		<form id="Form1" method="post" runat="server">
			<asp:dropdownlist id="akt1" runat="server" visible="False">
				<asp:listitem value="REGIS">REGIS = Registrasi NUP</asp:listitem>
				<asp:listitem value="EDIT">EDIT = Edit NUP</asp:listitem>
				<asp:listitem value="DEL">DEL = Delete NUP (Permanen)</asp:listitem>
                <asp:listitem value="P-TTNU">PRINT = Print Form NUP</asp:listitem>
                <asp:listitem value="R-TTNU">RE-PRINT = Re-Print Form NUP</asp:listitem>
                <asp:listitem value="PY-NUP">PEMBAYARAN = Pembayaran NUP</asp:listitem>
                <asp:listitem value="PY-NUP">PELUNASAN = Pelunasan NUP</asp:listitem>
			</asp:dropdownlist>

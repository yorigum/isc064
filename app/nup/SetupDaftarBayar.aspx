<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SetupDaftarBayar.aspx.cs" Inherits="ISC064.NUP.SetupDaftarBayar" %>
...
<html>
<head>
    <title>Minimum Pendaftaran NUP</title>
...
<body class="body-padding">
    <form id="Form1" method="post" runat="server" class="cnt">
        ...
        <div>
            <h1 class="title title-line">Minimum Pendaftaran NUP</h1>
            <br>
            <table>
                <tr>
                    <td>

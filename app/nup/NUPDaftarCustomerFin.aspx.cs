...
{
    public partial class NUPDaftarCustomerFin : System.Web.UI.Page
    {
        ...
        private void Fill()
        {
            ...
            if (dtNUP.Rows.Count > 0)
            {
                ...
                agent.Text = namaAG;
                asp.HRef = "javascript:openPopUp('PrintNUP.aspx?NoNUP=" + NoNUP + "&Tipe=" + Tipe + "&Project=" + Project + "','920','650')";
                adaftar.HRef = "NUPDaftarCustomer.aspx";
            }

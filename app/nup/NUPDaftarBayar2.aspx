...
<%@ Page Language="c#" Inherits="ISC064.NUP.NUPDaftarBayar2" CodeFile="NUPDaftarBayar2.aspx.cs" %>
...
<body class="body-padding" onkeyup="if(document.getElementById('cancel')){if(event.keyCode==27)document.getElementById('cancel').click()}">
    ...
    <h1 class="title title-line">Pembayaran Registrasi</h1>
            ...
            <td>
                ...
                <table cellspacing="5" style="width: 400px; float: right;">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <input id="cancel" runat="server" class="btn btn-red" onclick="location.href='NUPDaftarBayar.aspx'; return false;"

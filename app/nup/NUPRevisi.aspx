...
<%@ Page Language="c#" Inherits="ISC064.NUP.NUPRevisi" CodeFile="NUPRevisi.aspx.cs" %>
    ...
    <form id="Form1" method="post" runat="server" class="cnt">
        ...
        <table cellspacing="0">
            <tr valign="top">
                <td>
                    ...
                    <table cellspacing="5" style="width: 430px; float: right;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="jenisproperti" runat="server" Width="280" CssClass="ddl">
                                    <asp:ListItem Value="0">Pilih Jenis Properti :</asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <tr id="trsave" runat="server">
                            ...
                            <td colspan="2">
                                <input id="cancel" runat="server" class="btn btn-red" onclick="location.href = 'NUP.aspx'; return false;"
                ...
                <td>
                    <table cellspacing="5" style="width: 400px; float: left;" runat="server" id="otorisasi">
                        <tr>
                            <td colspan="3">
                                <p style="font-size: 12pt">

<%@ Page Language="c#" Inherits="ISC064.NUP.CustomerUploadPP" CodeFile="CustomerUploadPP.aspx.cs" %>
    ...
    <form id="Form1" method="post" runat="server" class="cnt">
        ...
        <asp:Table ID="rule" runat="server" CssClass="tb blue-skin" CellSpacing="1">
            ...
            <asp:TableRow>
                ...
                <asp:TableCell>RANGE</asp:TableCell>
                <asp:TableCell></asp:TableCell>
                <asp:TableCell CssClass="sm">TR</asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
        ...
        <table height="50">
            <tr>
                <td>
                    <asp:Button ID="upload" runat="server" CssClass="btn btn-blue" Width="100" Text="OK" OnClick="upload_Click"></asp:Button>
                </td>
            </tr>
            <tr>

	...
	public partial class LogPk : System.Web.UI.Page
	{
		...
		{            
			string strSql = "SELECT"
				...
				+ " WHERE Pk = '"+Pk+"' AND Tipe = '" + Tipe + "' AND Project = '"+Project+"' ORDER BY LogID";            
			...
			for(int i=0;i<rs.Rows.Count;i++)
			{
				...
				c = new TableCell();
				c.Text = "<a href=\"javascript:popLog('"+rs.Rows[i]["LogID"]+"','"+tb.SelectedValue+"','"+tb.SelectedItem.Text+"','"+Pk+"','"+Tipe+"')\">"

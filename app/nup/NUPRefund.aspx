...
<%@ Page Language="c#" Inherits="ISC064.NUP.NUPRefund" CodeFile="NUPRefund.aspx.cs" %>
...
<head>
    ...
    <meta name="sec" content="NUP - Refund NUP">
    <style type="text/css">
        .sm TD {
            font-weight: normal;
            font-size: 8pt;
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                &nbsp;/&nbsp;
                            <asp:TextBox ID="chp" runat="server" CssClass="txt" Width="90" ReadOnly="True" Style="border: none; text-align: left;"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>No. KTP
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                <asp:TextBox ID="bank" runat="server" with="120"></asp:TextBox>(Bank)
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                <asp:TextBox ID="cabang" runat="server"  with="120"></asp:TextBox>(Cabang)
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                <asp:TextBox ID="norek" runat="server"  with="120"></asp:TextBox>(No. Rekening)
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                <asp:TextBox ID="ats" runat="server" with="120"></asp:TextBox>(Atas Nama)
                            </td>
                        </tr>
                    </table>
                    <table>

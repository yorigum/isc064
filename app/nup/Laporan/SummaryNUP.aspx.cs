...
namespace ISC064.NUP.Laporan
{
    ...
    public partial class SummaryNUP : System.Web.UI.Page
	{
        ...
        {
            //Sales
            DataTable rs = Db.Rs("SELECT * FROM ISC064_SECURITY..USERNAME WHERE SecLevel='ADM SALES'");
		...
		private void Report()
		{
            ...
            if (admin.SelectedIndex != 0)
                addStr = Db.SingleString("SELECT Nama FROM ISC064_SECURITY..USERNAME WHERE UserID='" + admin.SelectedValue + "'");
